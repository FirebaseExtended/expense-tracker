...
import { FirebaseError as f, getUA as d, isSafari as p, isMobileCordova as y, isReactNative as v, isElectron as m, isIE as g, isUWP as w, isBrowserExtension as b, getModularInstance as I, createMockUserToken as T, deepEqual as E, isIndexedDBAvailable as S } from "@firebase/util";

import { XhrIo as _, EventType as D, ErrorCode as N, createWebChannelTransport as A, getStatEventTarget as x, FetchXmlHttpFactory as C, WebChannel as k, Event as M, Stat as V } from "@firebase/webchannel-wrapper";

var R = "@firebase/firestore", L = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
 ...
 */ var H = {
    ...
    t.prototype.u = function() {
        ...
        return z(null === t || "string" == typeof t), new L(t);
    }, t;
}(), et = function(t, e, n) {
...
function qt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? At(t) ? 4 /* ServerTimestampValue */ : Zt(t) ? 9 /* ArrayValue */ : 10 /* ObjectValue */ : j();
}
...
function Kt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = ct(Dt(t.latitude), Dt(e.latitude));
            return 0 !== n ? n : ct(Dt(t.longitude), Dt(e.longitude));
...
function ne(t, e) {
    return void 0 === t ? e : void 0 === e || Kt(t, e) > 0 ? t : e;
}
...
function ge(t) {
    ...
    if (null === e.P) {
        ...
        })).join(","), Vt(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
...
/** Returns the field filters that target the given field path. */ function Ie(t, e) {
    return t.filters.filter((function(t) {
        return t instanceof Se && t.field.isEqual(e);
    }));
}
 ...
 */ function Te(t, e, n) {
    ...
    for (var r, i = !0, o = 0, u = Ie(t, e); o < u.length; o++) {
        var s = u[o], a = void 0, c = !0;
        switch (s.op) {
          case "<" /* LESS_THAN */ :
...
var Se = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.V(t, e, r) : new _e(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new xe(t, r) : "in" /* IN */ === e ? new Ce(t, r) : "not-in" /* NOT_IN */ === e ? new ke(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Me(t, r) : new n(t, e, r);
    }, n.V = function(t, e, n) {
        return "in" /* IN */ === e ? new De(t, n) : new Ne(t, n);
...
/** A Filter that implements the array-contains operator. */ var xe = /** @class */ function(e) {
    function n(t, n) {
...
/** Creates a new Query instance with the options provided. */ function qe(t, e, n, r, i, o, u, s) {
    return new Fe(t, e, n, r, i, o, u, s);
}
 ...
 */ function Qe(t) {
    ...
    if (null === e.D) {
        ...
        n.isKeyField() || e.D.push(new Re(n)), e.D.push(new Re(bt.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function We(t) {
    var e = W(t);
    if (!e.C) if ("F" /* First */ === e.limitType) e.C = me(e.path, e.collectionGroup, Qe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Qe(e); r < i.length; r++) {
            var o = i[r], u = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new Re(o.field, u));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var s = e.endAt ? new Ve(e.endAt.position, !e.endAt.inclusive) : null, a = e.startAt ? new Ve(e.startAt.position, !e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
                e.C = me(e.path, e.collectionGroup, n, e.filters, e.limit, s, a);
    }
    return e.C;
}
...
function Ye(t, e) {
    return we(We(t), We(e)) && t.limitType === e.limitType;
}
...
function Je(t) {
    return "Query(target=" + function(t) {
        ...
        Vt(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return function(t) {
                return t.field.canonicalString() + " (" + t.dir + ")";
            }(t);
    ...
    }(We(t)) + "; limitType=" + t.limitType + ")";
}

/** Returns whether `doc` matches the constraints of `query`. */ function $e(t, e) {
 ...
 */
        ...
        }(t.startAt, Qe(t), e)) && !(t.endAt && !function(t, e, n) {
            var r = Pe(t, e, n);
            return t.inclusive ? r >= 0 : r > 0;
        }(t.endAt, Qe(t), e));
    }(t, e);
 ...
 */ function tn(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = Qe(t); i < o.length; i++) {
            var u = o[i], s = en(u, e, n);
            if (0 !== s) return s;
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ var un = function() {
 ...
 */ function sn(t, e, n) {
    ...
    }(n, e) : t instanceof hn ? fn(t, e) : t instanceof dn ? pn(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = cn(t, e), r = vn(n) + vn(t.k);
        return Wt(n) && Wt(t.k) ? rn(r) : nn(t.M, r);
    }(t, e);
}
 ...
 */ function an(t, e, n) {
    ...
    // applications.
    return t instanceof hn ? fn(t, e) : t instanceof dn ? pn(t, e) : n;
}
 ...
 */ function cn(t, e) {
    return t instanceof yn ? Wt(n = e) || function(t) {
...
/** Transforms an array value via a remove operation. */ var dn = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
    }
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var gn = function(t, e) {
 ...
 */
/** Returns true if the preconditions is valid for the given document. */ function In(t, e) {
 ...
 */ function En(t, e, n) {
    t instanceof An ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = kn(t.fieldTransforms, e, n.transformResults);
        r.setAll(i), e.convertToFoundDocument(n.version, r).setHasCommittedMutations();
    }(t, e, n) : t instanceof xn ? function(t, e, n) {
        if (In(t.precondition, e)) {
            var r = kn(t.fieldTransforms, e, n.transformResults), i = e.data;
 ...
 */ function Sn(t, e, n) {
    t instanceof An ? function(t, e, n) {
        if (In(t.precondition, e)) {
            var r = t.value.clone(), i = Mn(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(Nn(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof xn ? function(t, e, n) {
        if (In(t.precondition, e)) {
            var r = Mn(t.fieldTransforms, n, e), i = e.data;
            i.setAll(Cn(t)), i.setAll(r), e.convertToFoundDocument(Nn(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        In(t.precondition, e) && 
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && lt(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof hn && e instanceof hn || t instanceof dn && e instanceof dn ? lt(t.elements, e.elements, Ut) : t instanceof yn && e instanceof yn ? Ut(t.k, e.k) : t instanceof ln && e instanceof ln;
...
/** A mutation that deletes the document at the given key. */ var Vn, Rn, Ln = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (Rn = Vn || (Vn = {}))[Rn.OK = 0] = "OK", Rn[Rn.CANCELLED = 1] = "CANCELLED", 
...
var Un = /** @class */ function() {
    ...
    function t(t, e) {
        this.comparator = t, this.root = e || Gn.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.insert = function(e, n) {
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, Gn.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, Gn.BLACK, null, null));
    }, 
    ...
    t.prototype.getIterator = function() {
        return new Kn(this.root, null, this.comparator, !1);
    }, t.prototype.getIteratorFrom = function(t) {
        return new Kn(this.root, t, this.comparator, !1);
    }, t.prototype.getReverseIterator = function() {
        return new Kn(this.root, null, this.comparator, !0);
    }, t.prototype.getReverseIteratorFrom = function(t) {
        return new Kn(this.root, t, this.comparator, !0);
    }, t;
}(), Kn = /** @class */ function() {
    function t(t, e, n, r) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
Gn.EMPTY = null, Gn.RED = !0, Gn.BLACK = !1, 
// end LLRBEmptyNode
Gn.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
var jn = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.firstAfterOrEqual = function(t) {
        ...
        return new zn(this.data.getIterator());
    }, t.prototype.getIteratorFrom = function(t) {
        return new zn(this.data.getIteratorFrom(t));
    }, 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Wn = new Bn(Pt.comparator);

function Hn() {
    return Wn;
}

var Yn = new Bn(Pt.comparator);
...
var $n = new Bn(Pt.comparator), Zn = new jn(Pt.comparator);

function tr() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = Zn, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var rr = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, ir.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(dt.min(), r, nr(), Hn(), tr());
    }, t;
}(), ir = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(Et.EMPTY_BYTE_STRING, n, tr(), tr(), tr());
    }, t;
}(), or = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    function t() {
        ...
        this.U = Et.EMPTY_BYTE_STRING, this.q = !1, 
        /**
    ...
    t.prototype.yt = function(t) {
        ...
        var i = new rr(t, n, this.ot, this.it, r);
        return this.it = Hn(), this.rt = lr(), this.ot = new jn(ct), i;
    }, 
    /**
    ...
    t.prototype.Z = function(t) {
        ...
        var e = this.st.get(t);
        return e || (e = new ar, this.st.set(t, e)), e;
    }, t.prototype.Tt = function(t) {
        var e = this.rt.get(t);
        return e || (e = new jn(ct), this.rt = this.rt.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.dt = function(t) {
        var e = this;
        this.st.set(t, new ar), this.nt.getRemoteKeysForTarget(t).forEach((function(n) {
...
function Sr(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? gt.emptyPath() : Dr(e);
}
...
function Ar(t, e, n) {
    var r = Tr(t, e.name), i = gr(e.updateTime), o = new ie({
        mapValue: {
            fields: e.fields
        }
...
function xr(t, e) {
    ...
    if (e instanceof An) n = {
        update: Nr(t, e.key, e.value)
    }; else if (e instanceof Ln) n = {
        delete: Ir(t, e.key)
    }; else if (e instanceof xn) n = {
        update: Nr(t, e.key, e.data),
        updateMask: Br(e.fieldMask)
    }; else {
        if (!(e instanceof Pn)) return j();
        n = {
            verify: Ir(t, e.key)
        };
    }
...
function Cr(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? bn.updateTime(gr(t.updateTime)) : void 0 !== t.exists ? bn.exists(t.exists) : bn.none();
    }(e.currentDocument) : bn.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) z("REQUEST_TIME" === e.setToServerValue), n = new ln; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new hn(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new dn(i);
            } else "increment" in e ? n = new yn(t, e.increment) : j();
    ...
    if (e.update) {
        e.update.name;
        var i = Tr(t, e.update.name), o = new ie({
            mapValue: {
...
function Mr(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Er(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Er(t, r.popLast()), n.structuredQuery.from = [ {
...
function Vr(t) {
    var e = Sr(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        z(1 === r);
        var o = n.from[0];
    ...
    var u = [];
    n.where && (u = Rr(n.where));
    var s = [];
    n.orderBy && (s = n.orderBy.map((function(t) {
        return function(t) {
            return new Re(Fr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    n.limit && (a = function(t) {
        var e;
        return Vt(e = "object" == typeof t ? t.value : t) ? null : e;
    }(n.limit));
    var c = null;
    ...
    return n.endAt && (l = function(t) {
        var e = !t.before, n = t.values || [];
        return new Ve(n, e);
    }(n.endAt)), qe(e, i, s, u, a, "F" /* First */ , c, l);
}

function Rr(t) {
    return t ? void 0 !== t.unaryFilter ? [ Ur(t) ] : void 0 !== t.fieldFilter ? [ qr(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Rr(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : j() : [];
...
function qr(t) {
    return Se.create(Fr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function Ur(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        ...
        return Se.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = Fr(t.unaryFilter.field);
        return Se.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = Fr(t.unaryFilter.field);
        return Se.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = Fr(t.unaryFilter.field);
        return Se.create(i, "!=" /* NOT_EQUAL */ , {
            nullValue: "NULL_VALUE"
        });
 ...
 */ function Gr(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = zr(e)), e = jr(t.get(n), e);
    return zr(e);
}

/** Encodes a single segment of a resource path into the given result */ function jr(t, e) {
 ...
 * information.
 */ var Xr = {}, Jr = [ "prefixPath", "collectionGroup", "readTime", "documentId" ], $r = [ "prefixPath", "collectionGroup", "documentId" ], Zr = [ "collectionGroup", "readTime", "prefixPath", "documentId" ], ti = [ "canonicalId", "targetId" ], ei = [ "targetId", "path" ], ni = [ "path", "targetId" ], ri = [ "collectionId", "parent" ], ii = [ "indexId", "uid" ], oi = [ "uid", "sequenceNumber" ], ui = [ "indexId", "uid", "arrayValue", "directionalValue", "orderedDocumentKey", "documentKey" ], si = [ "indexId", "uid", "orderedDocumentKey" ], ai = [ "userId", "collectionPath", "documentId" ], ci = [ "userId", "collectionPath", "largestBatchId" ], li = [ "userId", "collectionGroup", "largestBatchId" ], hi = e(e([], e(e([], e(e([], e(e([], [ "mutationQueues", "mutations", "documentMutations", "remoteDocuments", "targets", "owner", "targetGlobal", "targetDocuments" ]), [ "clientMetadata" ])), [ "remoteDocumentGlobal" ])), [ "collectionParents" ])), [ "bundles", "namedQueries" ]), fi = e(e([], hi), [ "documentOverlays" ]), di = [ "mutationQueues", "mutations", "documentMutations", "remoteDocumentsV14", "targets", "owner", "targetGlobal", "targetDocuments", "clientMetadata", "remoteDocumentGlobal", "collectionParents", "bundles", "namedQueries", "documentOverlays" ], pi = e(e([], di), [ "indexConfiguration", "indexState", "indexEntries" ]), yi = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", vi = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        this.At = new X, this.transaction.oncomplete = function() {
            ...
            e.error ? n.At.reject(new Ii(t, e.error)) : n.At.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Di(e.target.error);
            n.At.reject(new Ii(t, r));
        };
    }
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return U("SimpleDb", "Removing database:", t), Si(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
 ...
 */ var Ei = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return U("SimpleDb", "ADD", this.store.name, t, t), Si(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return Si(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), U("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return U("SimpleDb", "DELETE", this.store.name, t), Si(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return U("SimpleDb", "COUNT", this.store.name), Si(this.store.count());
    ...
    t.prototype.zt = function(t) {
        var e = this.cursor({});
        return new mi((function(n, r) {
            e.onerror = function(t) {
                var e = Di(t.target.error);
                r(e);
        ...
        var n = [];
        return new mi((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new bi(i), u = e(i.primaryKey, i.value, o);
                    if (u instanceof mi) {
                        var s = u.catch((function(t) {
                            return o.done(), mi.reject(t);
                        }));
                        n.push(s);
                    }
 ...
 */ var xi = /** @class */ function() {
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && Sn(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var u = o[i];
            u.key.isEqual(t.key) && Sn(u, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = $n, o = e.mutations, u = 0; u < o.length; u++) i = i.insert(o[u].key, r[u].version);
     ...
     * time from which the server should resume sending results.
     */ , u) {
        void 0 === i && (i = dt.min()), void 0 === o && (o = dt.min()), void 0 === u && (u = Et.EMPTY_BYTE_STRING), 
...
/** Encodes a document for storage locally. */ function Ri(t, e) {
    var n = e.key, r = {
    ...
    if (e.isFoundDocument()) r.document = function(t, e) {
        return {
            ...
            updateTime: yr(t, e.version.toTimestamp())
        };
    }(t.Jt, e); else if (e.isNoDocument()) r.noDocument = {
        path: n.path.toArray(),
        readTime: Pi(e.version)
    }; else {
        if (!e.isUnknownDocument()) return j();
        r.unknownDocument = {
            path: n.path.toArray(),
            version: Pi(e.version)
        };
    }
    return r;
}
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Fi(t, e) {
    ...
    return new xi(e.batchId, s, n, u);
}

/** Decodes a DbTarget into TargetData */ function qi(t) {
    var e, n, r = Oi(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Oi(t.lastLimboFreeSnapshotVersion) : dt.min();
    return void 0 !== t.query.documents ? (z(1 === (n = t.query).documents.length), 
    e = We(Ue(Sr(n.documents[0])))) : e = function(t) {
        return We(Vr(t));
    }(t.query), new Mi(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, Et.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function Ui(t, e) {
    var n, r = Pi(e.snapshotVersion), i = Pi(e.lastLimboFreeSnapshotVersion);
    n = be(e.target) ? kr(t.Jt, e.target) : Mr(t.Jt, e.target);
...
/** Encodes a DbDocumentOverlay object to an Overlay model object. */ function Ki(t, e) {
    return new ki(e.largestBatchId, Cr(t.Jt, e.overlayMutation));
}
 ...
 */ var Wi = /** @class */ function() {
    ...
    return t.Yt = function(e, n) {
        ...
        var n = this;
        return Hi(t).get(Gi(this.userId, e)).next((function(t) {
            return t ? Ki(n.M, t) : null;
        }));
        ...
        e.forEach((function(t) {
            return i.add(Gr(t.getCollectionPath()));
        }));
        var o = [];
        return i.forEach((function(e) {
            ...
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            o.push(Hi(t).Qt("collectionPathOverlayIndex", i));
        })), mi.waitFor(o);
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        var r = this, i = Jn(), o = Gr(e), u = IDBKeyRange.bound([ this.userId, o, n ], [ this.userId, o, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Hi(t).qt("collectionPathOverlayIndex", u).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) {
                var o = n[e], u = Ki(r.M, o);
                i.set(u.getKey(), u);
            }
            return i;
        }));
    }, t.prototype.getOverlaysForCollectionGroup = function(t, e, n, r) {
        var i, o = this, u = Jn(), s = IDBKeyRange.bound([ this.userId, e, n ], [ this.userId, e, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Hi(t).Wt({
        ...
        return Hi(t).put(function(t, e, n) {
            var r = Gi(e, n.mutation.key);
            return r[0], {
                userId: e,
                collectionPath: r[1],
                documentId: r[2],
                ...
                overlayMutation: xr(t.Jt, n.mutation)
            };
...
/** Firestore index value writer.  */ var Yi = /** @class */ function() {
    function t() {}
    ...
    /** Writes an index value.  */    return t.prototype.Zt = function(t, e) {
        ...
        e.se(t.booleanValue ? 1 : 0); else if ("integerValue" in t) this.ne(e, 15), e.se(Dt(t.integerValue)); else if ("doubleValue" in t) {
            var n = Dt(t.doubleValue);
            isNaN(n) ? this.ne(e, 13) : (this.ne(e, 15), Rt(n) ? 
        ...
        e.ue(Nt(t.bytesValue)), this.oe(e); else if ("referenceValue" in t) this.ae(t.referenceValue, e); else if ("geoPointValue" in t) {
...
var $i = /** @class */ function() {
    ...
    function t() {
        this.De = new $i, this.Ce = new Zi(this.De), this.xe = new to(this.De);
    }
...
function ro(t, e) {
    ...
    return 0 !== n ? n : 0 !== (n = io(t.arrayValue, e.arrayValue)) ? n : 0 !== (n = io(t.directionalValue, e.directionalValue)) ? n : Pt.comparator(t.documentKey, e.documentKey);
}
 ...
 */ var oo = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.qe.add(e), mi.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return mi.resolve(this.qe.getEntries(e));
        ...
        // Field indices are not supported with memory persistence.
        return mi.resolve(null);
    }, t.prototype.getFieldIndex = function(t, e) {
        // Field indices are not supported with memory persistence.
        return mi.resolve(null);
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new jn(gt.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new jn(gt.comparator)).toArray();
    }, t;
}(), ao = new Uint8Array(0), co = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return lo(t).qt(r).next((function(t) {
        ...
        return mi.forEach(this.Qe(e), (function(e) {
            return n.getFieldIndex(t, e).next((function(t) {
                i && (i = !!t), o.set(e, t);
            }));
        })).next((function() {
            if (i) {
                var t = tr(), u = [];
                return mi.forEach(o, (function(i, o) {
                    ...
                    })).join(",") + " to execute ") + ge(e));
                    var a = function(t, e) {
                        var n = ae(e);
                        if (void 0 === n) return null;
                        for (var r = 0, i = Ie(t, n.fieldPath); r < i.length; r++) {
                            var o = i[r];
                            switch (o.op) {
                        ...
                        for (var n = new Map, r = 0, i = ce(e); r < i.length; r++) for (var o = i[r], u = 0, s = Ie(t, o.fieldPath); u < s.length; u++) {
                            var a = s[u];
                            switch (a.op) {
                              case "==" /* EQUAL */ :
                              case "in" /* IN */ :
                        ...
                        for (var n = [], r = !0, i = 0, o = ce(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? Te(t, u.fieldPath, t.startAt) : Ee(t, u.fieldPath, t.startAt);
                            if (!s.value) 
                        ...
                        // endAt.
                        for (var n = [], r = !0, i = 0, o = ce(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? Ee(t, u.fieldPath, t.endAt) : Te(t, u.fieldPath, t.endAt);
                            if (!s.value) 
                        ...
                        return new Ve(n, r);
                    }(o, i), f = n.je(i, o, l), d = n.je(i, o, h), p = n.We(i, o, c), y = n.ze(i.indexId, a, f, !!l && l.inclusive, d, !!h && h.inclusive, p);
                    return mi.forEach(y, (function(n) {
     ...
     * bounds.
     */
    t.prototype.ze = function(t, e, n, r, i, o, u) {
        for (var s = this, a = (null != e ? e.length : 1) * Math.max(null != n ? n.length : 1, null != i ? i.length : 1), c = a / (null != e ? e.length : 1), l = [], h = function(a) {
            var h = e ? f.He(e[a / c]) : ao, d = n ? f.Je(t, h, n[a % c], r) : f.Ye(t), p = i ? f.Xe(t, h, i[a % c], o) : f.Ye(t + 1);
            l.push.apply(l, f.createRange(d, p, u.map((function(e) {
                return s.Je(t, h, e, 
                /* inclusive= */ !0);
            }))));
        }, f = this, d = 0
    ...
    /** Generates the lower bound for `arrayValue` and `directionalValue`. */ t.prototype.Je = function(t, e, n, r) {
        var i = new no(t, Pt.empty(), e, n);
        return r ? i : i.ke();
    }, 
    ...
    t.prototype.Ye = function(t) {
        return new no(t, Pt.empty(), ao, ao);
    }, t.prototype.getFieldIndex = function(t, e) {
        var n = new oo(e), r = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment();
    ...
    t.prototype.Ze = function(t, e) {
        for (var n = new eo, r = 0, i = ce(t); r < i.length; r++) {
    ...
    /** Encodes a single value to the ascending index format. */ t.prototype.He = function(t) {
        var e = new eo;
    ...
    t.prototype.nn = function(t, n, r) {
        for (var i = e([], t), o = [], u = 0, s = r.arrayValue.values || []; u < s.length; u++) for (var a = s[u], c = 0, l = i; c < l.length; c++) {
            var h = l[c], f = new eo;
            f.seed(h.Se()), Yi.fe.Zt(a, f.Ne(n.kind)), o.push(f);
        }
        return o;
    }, t.prototype.en = function(t, e) {
        return !!t.filters.find((function(t) {
            return t instanceof Se && t.field.isEqual(e) && ("in" /* IN */ === t.op || "not-in" /* NOT_IN */ === t.op);
        }));
    }, t.prototype.getFieldIndexes = function(t, e) {
        var n = this, r = fo(t), i = po(t);
        return (e ? r.qt("collectionGroupIndex", IDBKeyRange.bound(e, e)) : r.qt()).next((function(t) {
            var e = [];
            return mi.forEach(t, (function(t) {
                return i.get([ t.indexId, n.uid ]).next((function(n) {
                    e.push(function(t, e) {
                        var n = e ? new he(e.sequenceNumber, new pe(Oi(e.readTime), new Pt(Qr(e.documentKey)), e.largestBatchId)) : he.empty(), r = t.fields.map((function(t) {
                            var e = t[0], n = t[1];
        ...
        // here.
                return mi.forEach(e, (function(e, i) {
            var o = r.get(e.collectionGroup);
            return (o ? mi.resolve(o) : n.getFieldIndexes(t, e.collectionGroup)).next((function(o) {
                return r.set(e.collectionGroup, o), mi.forEach(o, (function(r) {
                    return n.on(t, e, r).next((function(e) {
                        var o = n.un(i, r);
                        return e.isEqual(o) ? mi.resolve() : n.an(t, i, r, e, o);
                    }));
                }));
            }));
        }));
        ...
        return ho(t).delete([ r.indexId, this.uid, r.arrayValue, r.directionalValue, this.tn(n, e.key), e.key.path.toArray() ]);
    }, t.prototype.on = function(t, e, n) {
        var r = ho(t), i = new jn(ro);
        return r.Wt({
            index: "documentKeyIndex",
            range: IDBKeyRange.only([ n.indexId, this.uid, this.tn(n, e) ])
        }, (function(t, r) {
            i = i.add(new no(n.indexId, e, r.arrayValue, r.directionalValue));
        })).next((function() {
            return i;
        }));
    }, 
    /** Creates the index entries for the given document. */ t.prototype.un = function(t, e) {
        var n = new jn(ro), r = this.Ze(e, t);
        if (null == r) return n;
        var i = ae(e);
        if (null != i) {
            ...
            if (Ht(o)) for (var u = 0, s = o.arrayValue.values || []; u < s.length; u++) {
                var a = s[u];
                n = n.add(new no(e.indexId, t.key, this.He(a), r));
            }
        } else n = n.add(new no(e.indexId, t.key, ao, r));
        return n;
    }, 
    /**
    ...
    t.prototype.an = function(t, e, n, r, i) {
        ...
        return function(t, e, n, r, i) {
            ...
            // `comparator`.
            for (var o = t.getIterator(), u = e.getIterator(), s = Qn(o), a = Qn(u); s || a; ) {
                var c = !1, l = !1;
                if (s && a) {
                    var h = n(s, a);
                    h < 0 ? 
                ...
                c ? (r(a), a = Qn(u)) : l ? (i(s), s = Qn(o)) : (s = Qn(o), a = Qn(u));
            }
        }(r, i, ro, (
        /* onAdd= */ function(r) {
            u.push(o.cn(t, e, n, r));
    ...
    t.prototype.createRange = function(t, e, n) {
        ...
        r.push(e);
        for (var c = [], l = 0; l < r.length; l += 2) c.push(IDBKeyRange.bound([ r[l].indexId, this.uid, r[l].arrayValue, r[l].directionalValue, ao, [] ], [ r[l + 1].indexId, this.uid, r[l + 1].arrayValue, r[l + 1].directionalValue, ao, [] ]));
        return c;
    }, t;
}();
 ...
 */
function lo(t) {
    return Ai(t, "collectionParents");
}

/**
 * Helper to get a typed SimpleDbStore for the index entry object store.
 */ function ho(t) {
    return Ai(t, "indexEntries");
}

/**
 * Helper to get a typed SimpleDbStore for the index configuration object store.
 */ function fo(t) {
    return Ai(t, "indexConfiguration");
}

/**
 * Helper to get a typed SimpleDbStore for the index state object store.
 */ function po(t) {
    return Ai(t, "indexState");
}
...
function mo(t, e, n) {
    ...
    for (var c = [], l = 0, h = n.mutations; l < h.length; l++) {
        var f = h[l], d = Yr(e, f.key.path, n.batchId);
        o.push(i.delete(d)), c.push(f.key);
    }
    return mi.waitFor(o).next((function() {
        return c;
    }));
}
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ vo.DEFAULT_COLLECTION_PERCENTILE = 10, 
vo.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, vo.DEFAULT = new vo(41943040, vo.DEFAULT_COLLECTION_PERCENTILE, vo.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
vo.DISABLED = new vo(-1, 0, 0);
...
var wo = /** @class */ function() {
    ...
    return t.Yt = function(e, n, r, i) {
        ...
        return u.add({}).next((function(s) {
            z("number" == typeof s);
            for (var a = new xi(s, e, n, r), c = function(t, e, n) {
            ...
            }(i.M, i.userId, a), l = [], h = new jn((function(t, e) {
                return ct(t.canonicalString(), e.canonicalString());
            })), f = 0, d = r; f < d.length; f++) {
                var p = d[f], y = Yr(i.userId, p.key.path, s);
                h = h.add(p.key.path.popLast()), l.push(u.put(c)), l.push(o.put(y, Xr));
            }
            return h.forEach((function(e) {
                l.push(i.indexManager.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.ln[s] = a.keys();
            })), mi.waitFor(l).next((function() {
                return a;
            }));
        }));
        ...
        return Io(t).get(e).next((function(t) {
            return t ? (z(t.userId === n.userId), Fi(n.M, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.fn = function(t, e) {
        var n = this;
        return this.ln[e] ? mi.resolve(this.ln[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.ln[e] = r, r;
            }
        ...
        return Io(t).Wt({
            ...
            e.userId === n.userId && (z(e.batchId >= r), o = Fi(n.M, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return Io(t).qt("userMutationsIndex", n).next((function(t) {
            return t.map((function(t) {
                return Fi(e.M, t);
            }));
        }));
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = Hr(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return To(t).Wt({
            range: i
        }, (function(r, i, u) {
            var s = r[0], a = r[1], c = r[2], l = Qr(a);
            ...
            return Io(t).get(c).next((function(t) {
                if (!t) throw j();
                z(t.userId === n.userId), o.push(Fi(n.M, t));
            }));
            u.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new jn(ct), i = [];
        return e.forEach((function(e) {
            var o = Hr(n.userId, e.path), u = IDBKeyRange.lowerBound(o), s = To(t).Wt({
                range: u
            }, (function(t, i, o) {
            ...
            i.push(s);
        })), mi.waitFor(i).next((function() {
            return n.dn(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = Hr(this.userId, r), u = IDBKeyRange.lowerBound(o), s = new jn(ct);
        return To(t).Wt({
            range: u
        }, (function(t, e, o) {
            var u = t[0], a = t[1], c = t[2], l = Qr(a);
        ...
        return e.forEach((function(e) {
            i.push(Io(t).get(e).next((function(t) {
                if (null === t) throw j();
                z(t.userId === n.userId), r.push(Fi(n.M, t));
            })));
        })), mi.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return mo(t.Ht, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n._n(e.batchId);
            })), mi.forEach(r, (function(e) {
    ...
    t.prototype._n = function(t) {
        ...
        return bo(t, this.userId, e);
    }, 
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    t.prototype.wn = function(t) {
        var e = this;
        return Eo(t).get(this.userId).next((function(t) {
            return t || {
                userId: e.userId,
 ...
 */ function bo(t, e, n) {
    var r = Hr(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), u = !1;
    return To(t).Wt({
        range: o,
        jt: !0
    }, (function(t, n, r) {
 ...
 */ function Io(t) {
    return Ai(t, "mutations");
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function To(t) {
    return Ai(t, "documentMutations");
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Eo(t) {
    return Ai(t, "mutationQueues");
}
 ...
 */ var So = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.pn(t).next((function(n) {
            var r = new So(n.highestTargetId);
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return Do(t).Wt((function(t, n) {
            var r = qi(n);
            e(r);
        }));
    }, t.prototype.pn = function(t) {
        return No(t).get("targetGlobalKey").next((function(t) {
            return z(null !== t), t;
        }));
    }, t.prototype.In = function(t, e) {
        return No(t).put("targetGlobalKey", e);
    }, t.prototype.Tn = function(t, e) {
        return Do(t).put(Ui(this.M, e));
    }, 
    /**
    ...
    t.prototype.En = function(t, e) {
        ...
        var n = ge(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return Do(t).Wt({
            range: r,
        ...
        // IndexedDb.
                return mi.forEach(e, (function(e) {
            var o = Gr(e.path);
            return mi.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }, t.prototype.removeMatchingKeysForTargetId = function(t, e) {
        var n = Ao(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = Ao(t), i = tr();
        return r.Wt({
            range: n,
            jt: !0
        }, (function(t, e, n) {
            var r = Qr(t[1]), o = new Pt(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = Gr(e.path), r = IDBKeyRange.bound([ n ], [ ht(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Ao(t).Wt({
 ...
 */ function No(t) {
    return Ai(t, "targetGlobal");
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function Ao(t) {
    return Ai(t, "targetDocuments");
}
 ...
 */ function xo(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== H.FAILED_PRECONDITION || t.message !== yi) throw t;
 ...
 */ var ko = /** @class */ function() {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Ti(e = n.sent()) ? (U("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        mi.resolve(yo)) : this.getCacheSize(t).next((function(r) {
    ...
    t.prototype.On = function(t, e) {
        return function(t, e) {
            var n = !1;
            return Eo(t).zt((function(r) {
                return bo(t, r, e).next((function(t) {
                    return t && (n = !0), mi.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (s <= e) {
                var a = n.On(t, u).next((function(e) {
                    ...
                    return o++, r.getEntry(t, u).next((function() {
                        return r.removeEntry(u, dt.min()), Ao(t).delete([ 0, Gr(u.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var Po = /** @class */ function() {
    function t() {
        ...
        this.changes = new Un((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? mi.resolve(n) : this.getFromCache(t, e);
    }, 
    /**
 ...
 */
    ...
    t.prototype.Un = function(t, e) {
        var n = this, r = Hn(), i = new Bn(Pt.comparator);
        return this.Ln(t, e, (function(t, e) {
            var o = n.$n(t, e);
            r = r.insert(t, o), i = i.insert(t, go(e));
        })).next((function() {
            return {
                documents: r,
                qn: i
        ...
        if (n.isEmpty()) return mi.resolve();
        var i = new jn(Go);
        n.forEach((function(t) {
            return i = i.add(t);
        }));
        var o = IDBKeyRange.bound(Bo(i.first()), Bo(i.last())), u = i.getIterator(), s = u.getNext();
        return Uo(t).Wt({
            index: "documentKeyIndex",
            range: o
        }, (function(t, n, i) {
            // Go through keys not found in cache.
            for (var o = Pt.fromSegments(e(e([], n.prefixPath), [ n.collectionGroup, n.documentId ])); s && Go(s, o) < 0; ) r(s, null), 
            s = u.getNext();
            s && s.isEqual(o) && (
            // Key found in cache.
        ...
        var r = this, i = [ e.popLast().toArray(), e.lastSegment(), Li(n.readTime), n.documentKey.path.isEmpty() ? "" : n.documentKey.path.lastSegment() ], o = [ e.popLast().toArray(), e.lastSegment(), [ Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER ], "" ];
        return Uo(t).qt(IDBKeyRange.bound(i, o, !0)).next((function(t) {
            for (var e = Hn(), n = 0, i = t; n < i.length; n++) {
        ...
        var i = this, o = Hn(), u = Ko(e, n), s = Ko(e, pe.max());
        return Uo(t).Wt({
        ...
        return new Fo(this, !!t && t.trackRemovals);
    ...
    t.prototype.$n = function(t, e) {
        if (e) {
            ...
            /** Decodes a remote document from storage locally to a Document. */ function(t, e) {
                var n;
                if (e.document) n = Ar(t.Jt, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
                    var r = Pt.fromSegments(e.noDocument.path), i = Oi(e.noDocument.readTime);
                    n = ue.newNoDocument(r, i), e.hasCommittedMutations && n.setHasCommittedMutations();
                } else {
                    if (!e.unknownDocument) return j();
                    var o = Pt.fromSegments(e.unknownDocument.path), u = Oi(e.unknownDocument.version);
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new jn((function(t, e) {
            return ct(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, u) {
            ...
            if (n.push(e.Kn.removeEntry(t, o, s.readTime)), u.isValidDocument()) {
                ...
                var l = Ri(e.Kn.M, u.convertToNoDocument(dt.min()));
                n.push(e.Kn.addEntry(t, o, l));
            }
        })), i.forEach((function(r) {
            n.push(e.Kn.indexManager.addToCollectionParentIndex(t, r));
        })), n.push(this.Kn.updateMetadata(t, r)), mi.waitFor(n);
 ...
 */ function qo(t) {
    return Ai(t, "remoteDocumentGlobal");
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Uo(t) {
    return Ai(t, "remoteDocumentsV14");
}
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var jo = /** @class */ function() {
    function t(t) {
        this.M = t;
    }
    /**
     ...
     */    return t.prototype.kt = function(t, e, n, r) {
        var i = this, o = new gi("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore("mutationQueues", {
                ...
                keyPath: "batchId",
                autoIncrement: !0
            }).createIndex("userMutationsIndex", Wr, {
                unique: !0
     ...
     */
        ...
        u = u.next((function() {
            ...
            !function(t) {
                ...
                e.createIndex("collectionPathOverlayIndex", ci, {
                    unique: !1
            ...
            return function(t) {
                ...
                e.createIndex("documentKeyIndex", $r), e.createIndex("collectionGroupIndex", Zr);
            }(t);
        })).next((function() {
            return i.Jn(t, o);
        })).next((function() {
            ...
            !function(t) {
                t.createObjectStore("indexConfiguration", {
                    ...
                    keyPath: ui
                }).createIndex("documentKeyIndex", si, {
                    unique: !1
                });
            }(t);
        }))), u;
        ...
        return n.qt().next((function(n) {
            return mi.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.qt("userMutationsIndex", i).next((function(r) {
                    return mi.forEach(r, (function(r) {
                        z(r.userId === n.userId);
                        var i = Fi(e.M, r);
                        return mo(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.Wn = function(t) {
        ...
        return t.store("targetGlobal").get("targetGlobalKey").next((function(t) {
            ...
            return n.Wt((function(n, i) {
                ...
                r.push(e.get(u).next((function(n) {
                    return n ? mi.resolve() : function(n) {
                        return e.put({
                            targetId: 0,
                            path: Gr(n),
        ...
        var n = e.store("collectionParents"), r = new so, i = function(t) {
            if (r.add(t)) {
...
var Qo = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Wo = /** @class */ function() {
    function t(
    /**
    ...
    l, h) {
        ...
        this.referenceDelegate = new Ro(this, i), this.hs = n + "main", this.M = new Vi(a), 
        this.ls = new wi(this.hs, this.ts, new jo(this.M)), this.fs = new _o(this.referenceDelegate, this.M), 
        this.ds = function(t) {
            return new Oo(t);
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new Y(H.FAILED_PRECONDITION, Qo);
    ...
    t.prototype.As = function(t) {
        var e = this;
        return this.Zn ? mi.resolve(!0) : Ho(t).get("owner").next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Yo(t).qt().next((function(t) {
    ...
    t.prototype.Fs = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Yo(e).qt().next((function(e) {
 ...
 */
        return function(t) {
            return Pt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.js(t, e.path) : ze(e) ? this.Ws(t, e, n) : this.zs(t, e, n);
        ...
        var r = this, i = e.collectionGroup, o = Xn();
        return this.indexManager.getCollectionParents(t, i).next((function(u) {
            return mi.forEach(u, (function(u) {
                var s = function(t, e) {
                    return new Fe(e, 
        ...
        // Query the remote documents and overlay mutations.
            ...
            for (var e = 0, n = t; e < n.length; e++) for (var i = n[e], o = 0, u = i.mutations; o < u.length; o++) {
                ...
                c = ue.newInvalidDocument(a), r = r.insert(a, c)), Sn(s, c, i.localWriteTime), c.isFoundDocument() || (r = r.remove(a));
            }
        })).next((function() {
    ...
    return t.Ys = function(e, n) {
        for (var r = tr(), i = tr(), o = 0, u = n.docChanges; o < u.length; o++) {
            var s = u[o];
            switch (s.type) {
              case 0 /* Added */ :
                r = r.add(s.doc.key);
    ...
    function t() {}
    /** Sets the document view to query against. */    return t.prototype.Xs = function(t) {
        this.Zs = t;
    }, 
    /** Returns all local documents matching the specified query. */ t.prototype.Qs = function(t, e, n, r) {
        ...
        }(e) || n.isEqual(dt.min()) ? this.ti(t, e) : this.Zs.Ks(t, r).next((function(o) {
            var u = i.ei(e, o);
            return (Be(e) || Ke(e)) && i.ni(e.limitType, u, r, n) ? i.ti(t, e) : (F() <= h.DEBUG && U("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Je(e)), 
            i.Zs.Qs(t, e, fe(n, -1)).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.ei = function(t, e) {
    ...
    t.prototype.ni = function(t, e, n, r) {
        ...
        return F() <= h.DEBUG && U("QueryEngine", "Using full collection scan to execute query:", Je(e)), 
    ...
    t, e, n, r) {
        this.persistence = t, this.si = e, this.M = r, 
        /**
    ...
    return t.prototype.ai = function(t) {
        ...
        this.ci = new Jo(this.ui, this.Bs, this.indexManager), this.ui.setIndexManager(this.indexManager), 
        this.si.Xs(this.ci);
    }, t.prototype.collectGarbage = function(t) {
        var e = this;
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", (function(n) {
            return t.collect(n, e.ii);
        }));
    }, t;
}();
              ...
              case 0:
                return [ 4 /*yield*/ , (n = W(t)).persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n.Bs.getAllMutationBatches(t).next((function(i) {
                        return r = i, n.ai(e), n.Bs.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var i = [], o = [], u = tr(), s = 0, a = r
                        ...
                        // of mutation batch IDs that were affected by change.
                                                return n.ci.Ks(t, u).next((function(t) {
                            return {
                                hi: t,
                                removedBatchIds: i,
                                addedBatchIds: o
 ...
 */ function ru(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), u = mi.resolve();
 ...
 * queue.
 */ function ou(t, e) {
    var n = W(t), r = e.snapshotVersion, i = n.ii;
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        ...
        e.targetChanges.forEach((function(o, s) {
            ...
            if (a) {
                ...
                e.targetMismatches.has(s) ? c = c.withResumeToken(Et.EMPTY_BYTE_STRING, dt.min()).withLastLimboFreeSnapshotVersion(dt.min()) : o.resumeToken.approximateByteSize() > 0 && (c = c.withResumeToken(o.resumeToken, r)), 
                i = i.insert(s, c), 
     ...
     */
        ...
        u.push(uu(t, o, e.documentUpdates).next((function(t) {
            s = t;
        }))), !r.isEqual(dt.min())) {
        ...
        return mi.waitFor(u).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.ci.Gs(t, s);
        })).next((function() {
 ...
 */ function au(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.fs.getTargetData(t, e).next((function(i) {
            ...
            r = i, mi.resolve(r)) : n.fs.allocateTargetId(t).next((function(i) {
                return r = new Mi(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.fs.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
        ...
        return (null === r || t.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.ii = n.ii.insert(t.targetId, t), 
...
function cu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = W(t), o = n.ii.get(e), u = i ? "readwrite" : "readwrite-primary", r.label = 1;
              ...
              case 5:
                return n.ii = n.ii.remove(e), n.ri.delete(o.target), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function lu(t, e, n) {
    var r = W(t), i = dt.min(), o = tr();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = r.ri.get(n);
            return void 0 !== i ? mi.resolve(r.ii.get(i)) : r.fs.getTargetData(e, n);
        }(r, t, We(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.fs.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.si.Qs(t, e, n ? i : dt.min(), n ? o : tr());
        })).next((function(t) {
            return du(r, Ze(e), t), {
                documents: t,
                li: o
...
// PORTING NOTE: Multi-Tab only.
function hu(t, e) {
    var n = W(t), r = W(n.fs), i = n.ii.get(e);
 ...
 */ function pu(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = W(t), u = tr(), s = Hn(), a = 0, c = i; a < c.length; a++) l = c[a], h = e.fi(l.metadata.name), 
                l.document && (u = u.add(h)), (f = e.di(l)).setReadTime(e._i(l.metadata.readTime)), 
                s = s.insert(h, f);
                return d = n.ui.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , au(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return We(Ue(gt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return uu(t, d, s).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ function yu(t, e, i) {
    return void 0 === i && (i = tr()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , au(t, We(Bi(e.bundledQuery))) ];
              ...
              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = W(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // Update existing target data because the query from the bundle is newer.
                                        var u = n.withResumeToken(Et.EMPTY_BYTE_STRING, r);
                    return o.ii = o.ii.insert(u.targetId, u), o.fs.updateTargetData(t, u).next((function() {
 ...
 */ var vu = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return mi.resolve(this.wi.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return this.wi.set(e.id, {
            id: (n = e).id,
            version: n.version,
            createTime: gr(n.createTime)
        }), mi.resolve();
    }, t.prototype.getNamedQuery = function(t, e) {
        return mi.resolve(this.mi.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
        return this.mi.set(e.name, function(t) {
            return {
                name: t.name,
                query: Bi(t.bundledQuery),
                readTime: gr(t.readTime)
            };
        }(e)), mi.resolve();
    }, t;
}(), mu = /** @class */ function() {
    function t() {
        ...
        this.overlays = new Bn(Pt.comparator), this.gi = new Map;
    }
    return t.prototype.getOverlay = function(t, e) {
        return mi.resolve(this.overlays.get(e));
    }, t.prototype.saveOverlays = function(t, e, n) {
        var r = this;
        return n.forEach((function(n, i) {
            r.Xt(t, e, i);
        ...
        var r = this, i = this.gi.get(n);
        return void 0 !== i && (i.forEach((function(t) {
            return r.overlays = r.overlays.remove(t);
        })), this.gi.delete(n)), mi.resolve();
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        for (var r = Jn(), i = e.length + 1, o = new Pt(e.child("")), u = this.overlays.getIteratorFrom(o); u.hasNext(); ) {
        ...
        for (var i = new Bn((function(t, e) {
            ...
            if (u.getKey().getCollectionGroup() === e && u.largestBatchId > n) {
                ...
                null === s && (s = Jn(), i = i.insert(u.largestBatchId, s)), s.set(u.getKey(), u);
            }
        }
        for (var a = Jn(), c = i.getIterator(); c.hasNext() && (c.getNext().value.forEach((function(t, e) {
            return a.set(t, e);
        })), !(a.size() >= r)); ) ;
        return mi.resolve(a);
        ...
        if (null !== n) {
            ...
            if (null !== r) {
                var i = this.gi.get(r.largestBatchId).delete(n.key);
                this.gi.set(r.largestBatchId, i);
            }
            this.overlays = this.overlays.insert(n.key, new ki(e, n));
            // Create the association of this overlay to the given largestBatchId.
            var o = this.gi.get(e);
            void 0 === o && (o = tr(), this.gi.set(e, o)), this.gi.set(e, o.add(n.key));
        }
    }, t;
}(), gu = /** @class */ function() {
    function t() {
        // A set of outstanding references to a document sorted by key.
        this.yi = new jn(wu.pi), 
        // A set of outstanding references to a document sorted by target id.
        this.Ii = new jn(wu.Ti)
    ...
    /** Add references to the given document keys for the given ID. */ t.prototype.Ei = function(t, e) {
        var n = this;
    ...
    t.prototype.Pi = function(t) {
        ...
        var e = new Pt(new gt([])), n = new wu(e, t), r = new wu(e, t + 1), i = tr();
        return this.Ii.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new wu(t, 0), n = this.yi.firstAfterOrEqual(e);
    ...
    return t.pi = function(t, e) {
        return Pt.comparator(t.key, e.key) || ct(t.vi, e.vi);
    }, 
    /** Compare by ID then by key */ t.Ti = function(t, e) {
        return ct(t.vi, e.vi) || Pt.comparator(t.key, e.key);
    }, t;
}(), bu = /** @class */ function() {
    function t(t, e) {
        ...
        this.Di = new jn(wu.pi);
    }
    return t.prototype.checkEmpty = function(t) {
        return mi.resolve(0 === this.Bs.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.Si;
        this.Si++, this.Bs.length > 0 && this.Bs[this.Bs.length - 1];
        var o = new xi(i, e, n, r);
        this.Bs.push(o);
        // Track references by document key and index collection parents.
        for (var u = 0, s = r; u < s.length; u++) {
            var a = s[u];
            this.Di = this.Di.add(new wu(a.key, i)), this.indexManager.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return mi.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return mi.resolve(this.Ci(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.xi(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return mi.resolve(this.Bs.length > i ? this.Bs[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return mi.resolve(0 === this.Bs.length ? -1 : this.Si - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return mi.resolve(this.Bs.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new wu(e, 0), i = new wu(e, Number.POSITIVE_INFINITY), o = [];
        return this.Di.forEachInRange([ r, i ], (function(t) {
            var e = n.Ci(t.vi);
            o.push(e);
        })), mi.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new jn(ct);
        return e.forEach((function(t) {
            var e = new wu(t, 0), i = new wu(t, Number.POSITIVE_INFINITY);
            n.Di.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.vi);
            }));
        })), mi.resolve(this.Ni(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new wu(new Pt(i), 0), u = new jn(ct);
        // Find unique batchIDs referenced by all documents potentially matching the
        // query.
                return this.Di.forEachWhile((function(t) {
            var e = t.key.path;
            ...
            // TODO(mcg): we'll need a different scanner when we implement
            // ancestor queries.
            e.length === r && (u = u.add(t.vi)), !0);
        }), o), mi.resolve(this.Ni(u));
        ...
        var n = this;
        z(0 === this.ki(e.batchId, "removed")), this.Bs.shift();
        var r = this.Di;
        return mi.forEach(e.mutations, (function(i) {
            var o = new wu(i.key, e.batchId);
        ...
        var n = new wu(e, 0), r = this.Di.firstAfterOrEqual(n);
        return mi.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this.Bs.length, mi.resolve();
    }, 
    /**
    ...
    function t(t) {
        ...
        this.docs = new Bn(Pt.comparator), 
    ...
    t.prototype.addEntry = function(t, e) {
        var n = e.key, r = this.docs.get(n), i = r ? r.size : 0, o = this.Mi(e);
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return mi.resolve(n ? n.document.mutableCopy() : ue.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = Hn();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
        ...
        for (var r = Hn(), i = new Pt(e.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var u = o.getNext(), s = u.key, a = u.value.document;
            if (!e.isPrefixOf(s.path)) break;
            s.path.length > e.length + 1 || ye(de(a), n) <= 0 || (r = r.insert(a.key, a.mutableCopy()));
        }
        return mi.resolve(r);
    }, t.prototype.getAllFromCollectionGroup = function(t, e, n, r) {
        ...
        return mi.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.newChangeBuffer = function(t) {
...
}(Po), Eu = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.Fi = new Un((function(t) {
            return ge(t);
        }), we), 
        ...
        /**
             ...
             * IDs.
             */
        this.Bi = new gu, this.targetCount = 0, this.Li = So.gn();
    }
    return t.prototype.forEachTarget = function(t, e) {
        return this.Fi.forEach((function(t, n) {
            return e(n);
        })), mi.resolve();
    }, t.prototype.getLastRemoteSnapshotVersion = function(t) {
        return mi.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.getHighestSequenceNumber = function(t) {
        return mi.resolve(this.$i);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.Li.next(), mi.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Li = new So(e), this.highestTargetId = e), t.sequenceNumber > this.$i && (this.$i = t.sequenceNumber);
    }, t.prototype.addTargetData = function(t, e) {
        return this.Tn(e), this.targetCount += 1, mi.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        ...
        var r = this, i = 0, o = [];
        return this.Fi.forEach((function(u, s) {
            s.sequenceNumber <= e && null === n.get(s.targetId) && (r.Fi.delete(u), o.push(r.removeMatchingKeysForTargetId(t, s.targetId)), 
            i++);
        })), mi.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        return mi.resolve(this.targetCount);
    }, t.prototype.getTargetData = function(t, e) {
        var n = this.Fi.get(e) || null;
        return mi.resolve(n);
    }, t.prototype.addMatchingKeys = function(t, e, n) {
        return this.Bi.Ei(e, n), mi.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this.Bi.Ri(e, n);
        ...
        return mi.resolve(this.Bi.containsKey(e));
    }, t;
}(), Su = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.Ui = {}, this.overlays = {}, this.es = new ut(0), this.ns = !1, this.ns = !0, 
        this.referenceDelegate = t(this), this.fs = new Eu(this), this.indexManager = new uo, 
        this.ds = new Iu((function(t) {
            return n.referenceDelegate.qi(t);
        })), this.M = new Vi(e), this._s = new vu(this.M);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new mu, this.overlays[t.toKey()] = e), e;
    }, t.prototype.getMutationQueue = function(t, e) {
        var n = this.Ui[t.toKey()];
        return n || (n = new bu(e, this.referenceDelegate), this.Ui[t.toKey()] = n), n;
    }, t.prototype.getTargetCache = function() {
        return this.fs;
    }, t.prototype.getRemoteDocumentCache = function() {
        return this.ds;
        ...
        var i = new _u(this.es.next());
        return this.referenceDelegate.Ki(), n(i).next((function(t) {
        ...
        return mi.or(Object.values(this.Ui).map((function(n) {
            return function() {
    ...
    return t.zi = function(e) {
        ...
        return this.ji.addReference(n, e), this.Hi.delete(n.toString()), mi.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.ji.removeReference(n, e), this.Hi.add(n.toString()), mi.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        ...
        // Remove newly orphaned documents.
                return mi.forEach(this.Hi, (function(r) {
            var i = Pt.fromPath(r);
            return e.Ji(t, i).next((function(t) {
                t || n.removeEntry(i, dt.min());
            }));
        })).next((function() {
            return e.Wi = null, n.apply(t);
        }));
    }, t.prototype.updateLimboDocument = function(t, e) {
        var n = this;
        return this.Ji(t, e).next((function(t) {
            t ? n.Hi.delete(e.toString()) : n.Hi.add(e.toString());
        }));
        ...
        var n = this;
        return mi.or([ function() {
            return mi.resolve(n.ji.containsKey(e));
        }, function() {
            return n.persistence.getTargetCache().containsKey(t, e);
        }, function() {
            return n.persistence.Qi(t, e);
        } ]);
    }, t;
}();
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function Au(t, e, n) {
...
var Cu = /** @class */ function() {
    ...
    return t.Yi = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = nr(), u = 0; i && u < r.activeTargetIds.length; ++u) i = Lt(r.activeTargetIds[u]), 
    ...
    function t(t, e, n, r, i) {
        this.window = t, this.Yn = e, this.persistenceKey = n, this.er = r, this.syncEngine = null, 
        this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.nr = this.sr.bind(this), 
        this.ir = new Bn(ct), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.ur = Nu(this.persistenceKey, this.er), 
        this.ar = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.ir = this.ir.insert(this.er, new Ru), this.cr = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
        this.hr = new RegExp("^firestore_mutations_" + o + "_(\\d+)(?:_(.*))?$"), this.lr = new RegExp("^firestore_targets_" + o + "_(\\d+)$"), 
        this.dr = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.vt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.er && (o = this.getItem(Nu(this.persistenceKey, i))) && (u = Mu.Yi(i, o)) && (this.ir = this.ir.insert(u.clientId, u));
                    for (this.wr(), (s = this.storage.getItem(this.dr)) && (a = this.mr(s)) && this.gr(a), 
                    c = 0, l = this.rr; c < l.length; c++) h = l[c], this.sr(h);
                    return this.rr = [], 
        ...
        var e = !1;
        return this.ir.forEach((function(n, r) {
        ...
        // `Window.addEventListener`.
            ...
            if (U("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.ur) return void B("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                ...
                return n(e, void 0, void 0, (function() {
                    ...
                    return r(this, (function(r) {
                        switch (r.label) {
                          ...
                          case 2:
                            return this.lr.test(i.key) ? null !== i.newValue && (o = this.Dr(i.key, i.newValue)) ? [ 2 /*return*/ , this.Cr(o) ] : [ 3 /*break*/ , 7 ] : [ 3 /*break*/ , 3 ];

                          case 3:
                            return i.key !== this.dr ? [ 3 /*break*/ , 4 ] : null !== i.newValue && (u = this.mr(i.newValue)) ? [ 2 /*return*/ , this.gr(u) ] : [ 3 /*break*/ , 7 ];

                          case 4:
                            return i.key !== this.ar ? [ 3 /*break*/ , 5 ] : (s = function(t) {
                                var e = ut.A;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                          ...
                          case 5:
                            return i.key !== this._r ? [ 3 /*break*/ , 7 ] : (a = this.Nr(i.newValue), [ 4 /*yield*/ , Promise.all(a.map((function(t) {
                                return c.syncEngine.kr(t);
                            }))) ]);
        ...
        var r = new Cu(this.currentUser, t, e, n), i = Au(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Xi());
    }, t.prototype.Ir = function(t) {
        var e = Au(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
        ...
        var r = xu(this.persistenceKey, t), i = new ku(t, e, n);
        this.setItem(r, i.Xi());
     ...
     */
    t.prototype.vr = function(t, e) {
        var n = this.hr.exec(t), r = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
        return Cu.Yi(new L(i), r, e);
    }, 
    /**
    ...
    t.prototype.Dr = function(t, e) {
        var n = this.lr.exec(t), r = Number(n[1]);
        return ku.Yi(r, e);
    }, 
    /**
    ...
    t.prototype.mr = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.Mr(t.batchId, t.state, t.error) ] : (U("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
        ...
        return o.forEach((function(t) {
            ...
            o.has(t) || s.push(t);
        })), this.syncEngine.Fr(u, s).then((function() {
            n.ir = r;
        }));
    ...
    function t() {
        this.$r = new Ru, this.Br = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.$r = new Ru, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t.prototype.Lr = function(t) {
        ...
        for (var t = 0, e = this.Qr; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
    ...
    return t(n, e), n.prototype.co = function(t, e, n, r) {
        ...
        var r = [ this.io, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = A(), o = x(), u = {
        ...
        this.useFetchStreams && (u.xmlHttpFactory = new C({})), this.ao(u.initMessageHeaders, e, n), 
        ...
        y() || v() || m() || g() || w() || b() || (u.httpHeadersOverwriteParam = "$httpHeaders");
        var s = r.join("");
        U("Connection", "Creating WebChannel: " + s, u);
        var a = i.createWebChannel(s, u), c = !1, l = !1, h = new Uu({
            Wr: function(t) {
        ...
        return f(a, k.EventType.OPEN, (function() {
            ...
            l || (l = !0, U("Connection", "WebChannel transport closed"), h.no());
        })), f(a, k.EventType.ERROR, (function(t) {
            l || (l = !0, K("Connection", "WebChannel transport errored:", t), h.no(new Y(H.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    l = !0, h.no(new Y(u, s)), a.close();
                } else U("Connection", "WebChannel received:", n), h.so(n);
            }
    ...
    return t.prototype.oo = function(t, e, n, r, i) {
        var o = this.uo(t, e);
        U("RestConnection", "Sending: ", o, n);
        var u = {};
        return this.ao(u, r, i), this.co(t, o, u, n).then((function(t) {
            return U("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw K("RestConnection", t + " failed with error: ", e, "url: ", o, "request:", n), 
            e;
        }));
    }, t.prototype.ho = function(t, e, n, r, i) {
        // The REST API automatically aggregates all of the streamed results, so we
        // can just use the normal invoke() method.
        return this.oo(t, e, n, r, i);
    }, 
    /**
 ...
 * limitations under the License.
 */ function ju(t) {
    return new pr(t, /* useProto3Json= */ !0);
}
 ...
 */ var zu = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.Yn = t, this.timerId = e, this.fo = n, this._o = r, this.wo = i, this.mo = 0, 
        this.yo = null, 
    ...
    t.prototype.To = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this.mo + this.Eo()), r = Math.max(0, Date.now() - this.po), i = Math.max(0, n - r);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && U("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.mo + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
        this.yo = this.Yn.enqueueAfterDelay(this.timerId, i, (function() {
            return e.po = Date.now(), t();
        })), 
    ...
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ t.prototype.Eo = function() {
    ...
    function t(t, e, n, r, i, o, u, s) {
        ...
        /**
             ...
             * close.
             */
        this.Vo = 0, this.vo = null, this.So = null, this.stream = null, this.Do = new zu(t, e)
        /**
    ...
    t.prototype.Mo = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.xo() && null === this.vo && (this.vo = this.Yn.enqueueAfterDelay(this.Ro, 6e4, (function() {
            return t.Oo();
        })));
    }, 
    /** Sends a message to the underlying stream. */ t.prototype.Fo = function(t) {
        this.$o(), this.stream.send(t);
    }, 
    /** Called by the idle timer when the stream should close due to inactivity. */ t.prototype.Oo = function() {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(t) {
                return this.xo() ? [ 2 /*return*/ , this.close(0 /* Initial */) ] : [ 2 /*return*/ ];
            }));
        }));
    }, 
    /** Marks the stream as active again. */ t.prototype.$o = function() {
        this.vo && (this.vo.cancel(), this.vo = null);
    }, 
    /** Cancels the health check delayed operation. */ t.prototype.Bo = function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    return this.$o(), this.Bo(), this.Do.cancel(), 
                    // Invalidates any stream-related callbacks (e.g. from auth or the
                    // underlying stream), guaranteeing they won't execute.
                    this.Vo++, 4 /* Error */ !== t ? 
                    // If this is an intentional close ensure we don't delay our next connection attempt.
                    this.Do.reset() : e && e.code === H.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    B(e.toString()), B("Using maximum backoff delay to prevent overloading the backend."), 
                    this.Do.Io()) : e && e.code === H.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.Yr(e) ];
     ...
     */
    t.prototype.Lo = function() {}, t.prototype.auth = function() {
        var t = this;
        this.state = 1 /* Starting */;
        var e = this.Uo(this.Vo), n = this.Vo;
        ...
        var t = this;
        this.state = 5 /* Backoff */ , this.Do.To((function() {
    ...
    t.prototype.Uo = function(t) {
        ...
        return function(n) {
            e.Yn.enqueueAndForget((function() {
                return e.Vo === t ? n() : (U("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.N ? (z(void 0 === e || "string" == typeof e), Et.fromBase64String(e || "")) : (z(void 0 === e || e instanceof Uint8Array), 
                    Et.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), u = e.targetChange.cause, s = u && function(t) {
                    var e = void 0 === t.code ? H.UNKNOWN : qn(t.code);
                    return new Y(e, t.message || "");
                }(u);
                n = new sr(r, i, o, s || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = Tr(t, a.document.name), l = gr(a.document.updateTime), h = new ie({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), f = ue.newFoundDocument(c, l, h), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new or(d, p, f.key, f);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = Tr(t, y.document), m = y.readTime ? gr(y.readTime) : dt.min(), g = ue.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new or([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = Tr(t, b.document), T = b.removedTargetIds || [];
                n = new or([], T, I, null);
            } else {
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, _ = new On(S), D = E.targetId;
                n = new ur(D, _);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? dt.min() : e.readTime ? gr(e.readTime) : dt.min();
        }(t);
    ...
    n.prototype.jo = function(t) {
        var e = {};
        e.database = _r(this.M), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = be(r) ? {
                documents: kr(t, r)
            } : {
                query: Mr(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = vr(t, e.resumeToken) : e.snapshotVersion.compareTo(dt.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = yr(t, e.snapshotVersion.toTimestamp())), n;
        }(this.M, t);
        var n = function(t, e) {
            var n = function(t, e) {
                switch (e) {
     ...
     * given targetId.
     */
    n.prototype.Wo = function(t) {
        var e = {};
        e.database = _r(this.M), e.removeTarget = t, this.Fo(e);
    }, n;
    ...
    return t(n, e), Object.defineProperty(n.prototype, "Ho", {
        /**
    ...
    n.prototype.start = function() {
        ...
        z(!!t.streamToken), this.lastStreamToken = t.streamToken, this.zo) {
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (z(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? gr(t.updateTime) : gr(e);
                        ...
                        n = gr(e)), new wn(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = gr(t.commitTime);
            return this.listener.Yo(n, e);
        }
        // The first response is always the handshake response
                return z(!t.writeResults || 0 === t.writeResults.length), this.zo = !0, 
        this.listener.Xo();
    }, 
    /**
    ...
    n.prototype.Zo = function() {
        ...
        var t = {};
        t.database = _r(this.M), this.Fo(t);
    }, 
    /** Sends a group of mutations to the Firestore backend to apply. */ n.prototype.Jo = function(t) {
        var e = this, n = {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */ n.prototype.oo = function(t, e, n) {
        var r = this;
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ n.prototype.ho = function(t, e, n) {
        var r = this;
        return this.eu(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], u = i[1];
    ...
    return t.prototype.ru = function() {
        var t = this;
        0 === this.nu && (this.ou("Unknown" /* Unknown */), this.su = this.asyncQueue.enqueueAfterDelay("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
            return t.su = null, t.uu("Backend didn't respond within 10 seconds."), t.ou("Offline" /* Offline */), 
            Promise.resolve();
        })));
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        ...
        this.iu ? (B(e), this.iu = !1) : U("OnlineStateTracker", e);
...
e, i, o, u) {
    ...
    /**
             ...
             */
    this.du = [], this._u = u, this._u.Lr((function(t) {
        i.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return us(this) ? (U("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).fu.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Zu(e) ];

                                      case 1:
                                        return n.sent(), e.wu.set("Unknown" /* Unknown */), e.fu.delete(4 /* ConnectivityChange */), 
                                        [ 4 /*yield*/ , $u(e) ];
 ...
 */ function $u(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (!us(t)) return [ 3 /*break*/ , 4 ];
                e = 0, n = t.du, r.label = 1;
 ...
 */ function es(t, e) {
    var n = W(t), r = Ts(n);
    n.lu.delete(e), r.xo() && rs(n, e), 0 === n.lu.size && (r.xo() ? r.Mo() : us(n) && 
...
function os(t) {
    return us(t) && !Ts(t).Co() && t.lu.size > 0;
}

function us(t) {
    return 0 === W(t).fu.size;
}
...
function cs(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(n) {
            ...
            t.wu.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
        }));
    }));
}
...
function ls(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.wu.set("Online" /* Online */), !(e instanceof sr && 2 /* Removed */ === e.state && e.cause)) 
                    ...
                    return n(this, void 0, void 0, (function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return i < o.length ? (u = o[i], t.lu.has(u) ? [ 4 /*yield*/ , t.remoteSyncer.rejectListen(u, n) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                              case 2:
                                r.sent(), t.lu.delete(u), t.mu.removeTarget(u), r.label = 3;
              ...
              case 6:
                if (e instanceof or ? t.mu.ut(e) : e instanceof ur ? t.mu._t(e) : t.mu.ht(e), i.isEqual(dt.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;
                ...
                function(t, e) {
                    ...
                    // persistent view of these when applying the completed RemoteEvent.
                        ...
                        if (n.resumeToken.approximateByteSize() > 0) {
                            ...
                            // A watched target might have been removed already.
                                                        i && t.lu.set(r, i.withResumeToken(n.resumeToken, e));
                        }
                    })), 
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.lu.set(e, n.withResumeToken(Et.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                            ...
                            var r = new Mi(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            ns(t, r);
                        }
              ...
              case 11:
                return U("RemoteStore", "Failed to raise snapshot:", s = a.sent()), [ 4 /*yield*/ , hs(t, s) ];
        ...
        return r(this, (function(u) {
            switch (u.label) {
              case 0:
                ...
                return t.fu.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Zu(t) ];

              case 1:
                // Disable network and raise offline snapshots
                return u.sent(), t.wu.set("Offline" /* Offline */), i || (
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.fu.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , $u(t) ];
...
function ds(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = W(t), n = Es(e), i = e.hu.length > 0 ? e.hu[e.hu.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , su(e.localStore, i) ];

              case 3:
                return null === (o = r.sent()) ? (0 === e.hu.length && n.Mo(), [ 3 /*break*/ , 7 ]) : (i = o.batchId, 
                function(t, e) {
                    t.hu.push(e);
                    var n = Es(t);
              ...
              case 4:
                return u = r.sent(), [ 4 /*yield*/ , hs(e, u) ];
...
function ps(t) {
    return us(t) && !Es(t).Co() && t.hu.length > 0;
}
...
function ms(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = Es(t), n = 0, i = t.hu; n < i.length; n++) o = i[n], e.Jo(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function gs(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.hu.shift(), o = Ci.from(n, e, i), [ 4 /*yield*/ , fs(t, (function() {
...
function ws(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && Es(t).Ho ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return Fn(i = e.code) && i !== H.ABORTED ? (n = t.hu.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                Es(t).ko(), [ 4 /*yield*/ , fs(t, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                n.fu.add(3 /* CredentialChange */), [ 4 /*yield*/ , Zu(n) ];

              case 1:
                return r.sent(), i && 
                // Don't set the network status to Unknown if we are offline.
                n.wu.set("Unknown" /* Unknown */), [ 4 /*yield*/ , n.remoteSyncer.handleCredentialChange(e) ];

              case 2:
                return r.sent(), n.fu.delete(3 /* CredentialChange */), [ 4 /*yield*/ , $u(n) ];
 ...
 */ function Is(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), e ? (n.fu.delete(2 /* IsSecondary */), [ 4 /*yield*/ , $u(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.fu.add(2 /* IsSecondary */), [ 4 /*yield*/ , Zu(n) ]);

              case 3:
                r.sent(), n.wu.set("Unknown" /* Unknown */), r.label = 4;
 ...
 */ function Ts(t) {
    ...
    t.gu = function(t, e, n) {
        ...
        Yr: cs.bind(null, t),
        Qo: ls.bind(null, t)
    }), t.du.push((function(i) {
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.gu.ko(), os(t) ? is(t) : t.wu.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.gu.stop() ];

                  case 2:
                    e.sent(), ss(t), e.label = 3;
    ...
    t.yu = function(t, e, n) {
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.yu.ko(), [ 4 /*yield*/ , ds(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.hu.length > 0 && (U("RemoteStore", "Stopping write stream with " + t.hu.length + " pending writes"), 
                    t.hu = []), e.label = 4;
 ...
 */ function _s(t, e) {
    if (B("AsyncQueue", e + ": " + t), Ti(t)) return new Y(H.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var Ds = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = Xn(), this.sortedSet = new Bn(this.comparator)
        /**
    ...
    function t() {
        this.pu = new Bn(Pt.comparator);
    }
    return t.prototype.track = function(t) {
        var e = t.doc.key, n = this.pu.get(e);
        n ? 
        ...
        // Metadata->Added
        // Removed->Metadata
        j() : this.pu = this.pu.insert(e, t);
    }, t.prototype.Iu = function() {
        var t = [];
        return this.pu.inorderTraversal((function(e, n) {
            t.push(n);
        })), t;
    }, t;
}(), As = /** @class */ function() {
    ...
    this.queries = new Un((function(t) {
        return Xe(t);
    }), Ye), this.onlineState = "Unknown" /* Unknown */ , this.Eu = new Set;
};
 ...
 */ function ks(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = W(t), i = e.query, o = !1, (u = n.queries.get(i)) || (o = !0, u = new xs), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 2:
                return s.Tu = r.sent(), [ 3 /*break*/ , 4 ];

              case 3:
                return a = r.sent(), c = _s(a, "Initialization of query '" + Je(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, u), u.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.Au(n.onlineState), u.Tu && e.Ru(u.Tu) && Ls(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Ps = /** @class */ function() {
    ...
    return t.prototype.Ru = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new As(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
    ...
    t.prototype.di = function(t) {
        return t.metadata.exists ? Ar(this.M, t.document, !1) : ue.newNoDocument(this.fi(t.metadata.name), this._i(t.metadata.readTime));
    ...
    return t.prototype.ku = function(t) {
        ...
        for (var e = new Map, n = new Fs(this.M), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
            if (o.metadata.queries) for (var u = n.fi(o.metadata.name), s = 0, a = o.metadata.queries; s < a.length; s++) {
                var c = a[s], l = (e.get(c) || tr()).add(u);
                e.set(c, l);
            }
        }
        return e;
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , pu(this.localStore, new Fs(this.M), this.documents, this.Nu.id) ];

                  case 1:
                    t = r.sent(), e = this.Mu(this.documents), n = 0, i = this.queries, r.label = 2;

                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , yu(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
 ...
 */ var Bs = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = tr(), this.Uu = tn(t), this.qu = new Ds(this.Uu);
    }
    return Object.defineProperty(t.prototype, "Ku", {
        /**
    ...
    t.prototype.Gu = function(t, e) {
        var n = this, r = e ? e.Qu : new Ns, i = e ? e.qu : this.qu, o = e ? e.mutatedKeys : this.mutatedKeys, u = i, s = !1, a = Be(this.query) && i.size === this.query.limit ? i.last() : null, c = Ke(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var l = i.get(t), h = $e(n.query, e) ? e : null, f = !!l && n.mutatedKeys.has(l.key), d = !!h && (h.hasLocalMutations || 
            ...
            l && h ? l.data.isEqual(h.data) ? f !== d && (r.track({
                type: 3 /* Metadata */ ,
                doc: h
            }), p = !0) : n.ju(l, h) || (r.track({
                type: 2 /* Modified */ ,
                doc: h
            }), p = !0, (a && n.Uu(h, a) > 0 || c && n.Uu(h, c) < 0) && (
            ...
            o = o.delete(t)));
        })), Be(this.query) || Ke(this.query)) for (;u.size > this.query.limit; ) {
            var l = Be(this.query) ? u.last() : u.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        o.sort((function(t, e) {
            return function(t, e) {
                ...
                return n(t) - n(e);
            }(t.type, e.type) || r.Uu(t.doc, e.doc);
        })), this.Wu(n);
        var u = e ? this.zu() : [], s = 0 === this.Lu.size && this.current ? 1 /* Synced */ : 0 /* Local */ , a = s !== this.Bu;
        return this.Bu = s, 0 !== o.length || a ? {
            snapshot: new As(this.query, t.qu, i, o, t.mutatedKeys, 0 /* Local */ === s, a, 
            /* excludesMetadataChanges= */ !1),
            Hu: u
        } : {
            Hu: u
    ...
    t.prototype.Wu = function(t) {
        ...
        // updating many documents.
                var e = this.Lu;
        this.Lu = tr(), this.qu.forEach((function(e) {
            t.Ju(e.key) && (t.Lu = t.Lu.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Lu.has(e) || n.push(new Ks(e));
    ...
    t.prototype.Yu = function(t) {
        this.$u = t.li, this.Lu = tr();
        var e = this.Gu(t.documents);
    ...
    t.prototype.Xu = function() {
        return As.fromInitialDocuments(this.query, this.qu, this.mutatedKeys, 0 /* Local */ === this.Bu);
    }, t;
}(), js = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.ta = {}, this.ea = new Un((function(t) {
            return Xe(t);
        }), Ye), this.na = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.ia = new Bn(Pt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.ra = new Map, this.oa = new gu, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ua = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.aa = new Map, this.ca = So.yn(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                i = u.targetId, n.sharedClientState.addLocalQueryTarget(i), o = u.view.Xu(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                return [ 4 /*yield*/ , au(n.localStore, We(e)) ];

              case 2:
                return s = r.sent(), n.isPrimaryClient && ts(n.remoteStore, s), a = n.sharedClientState.addLocalQueryTarget(s.targetId), 
                i = s.targetId, [ 4 /*yield*/ , Hs(n, e, i, "current" === a) ];
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view.Gu(i), n.ni ? [ 4 /*yield*/ , lu(t.localStore, e.query, 
                                    /* usePreviousResults= */ !1).then((function(t) {
                                        var r = t.documents;
                                        return e.view.Gu(r, n);
                                    })) ] : [ 3 /*break*/ , 2 ];
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, u), [ 2 /*return*/ , (sa(t, e.targetId, s.Hu), 
                                    s.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , lu(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return u = f.sent(), s = new Gs(e, u.li), a = s.Gu(u.documents), c = ir.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                l = s.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), sa(t, i, l.Hu), h = new js(e, i, s), 
                [ 2 /*return*/ , (t.ea.set(e, h), t.na.has(i) ? t.na.get(i).push(e) : t.na.set(i, [ e ]), 
                l.snapshot) ];
            }
        }));
    }));
...
/** Stops listening to the query. */ function Ys(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), i = n.ea.get(e), (o = n.na.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.na.set(i.targetId, o.filter((function(t) {
                    return !Ye(t, e);
                }))), void n.ea.delete(e)) ] : n.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , cu(n.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), es(n.remoteStore, i.targetId), 
                    oa(n, i.targetId);
                })).catch(xo) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return oa(n, i.targetId), [ 4 /*yield*/ , cu(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.ci.Ks(t, o).next((function(o) {
                            n = o;
                            for (
                            ...
                            var u = [], s = 0, a = e; s < a.length; s++) {
                                var c = a[s], l = _n(c, n.get(c.key));
                                null != l && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                u.push(new xn(c.key, l, oe(l.value.mapValue), bn.exists(!0)));
                            }
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    var r = t.ua[t.currentUser.toKey()];
                    r || (r = new Bn(ct)), r = r.insert(e, n), t.ua[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , la(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , ds(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return u = r.sent(), s = _s(u, "Failed to persist write"), i.reject(s), [ 3 /*break*/ , 6 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , ou(n.localStore, e) ];
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    t.addedDocuments.size > 0 ? r.Zu = !0 : t.modifiedDocuments.size > 0 ? z(r.Zu) : t.removedDocuments.size > 0 && (z(r.Zu), 
                    r.Zu = !1));
                })), [ 4 /*yield*/ , la(n, i, e) ];
 ...
 */ function $s(t, e, n) {
    ...
    // SharedClientState.
        ...
        }(r.eventManager, e), i.length && r.ta.Qo(i), r.onlineState = e, r.isPrimaryClient && r.sharedClientState.setOnlineState(e);
    }
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = W(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.ra.get(e), 
                (u = o && o.key) ? (
                // TODO(b/217189216): This limbo document should ideally have a read time,
                // so that it is picked up by any read-time based scans. The backend,
                // however, does not send a read time for target removals.
                s = (s = new Bn(Pt.comparator)).insert(u, ue.newNoDocument(u, dt.min())), a = tr().add(u), 
                c = new rr(dt.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new jn(ct), s, a), [ 4 /*yield*/ , Js(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.ia = n.ia.remove(u), n.ra.delete(e), ca(n), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , cu(n.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return oa(n, e, i);
                })).catch(xo) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                ia(n, i, /*error=*/ null), ra(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , la(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                // listen events.
                ia(n, e, i), ra(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , la(n, o) ];
 ...
 */ function na(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                us((n = W(t)).remoteStore) || U("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 2:
                return -1 === (i = r.sent()) ? [ 2 /*return*/ , void e.resolve() ] : ((o = n.aa.get(i) || []).push(e), 
                n.aa.set(i, o), [ 3 /*break*/ , 4 ]);

              case 3:
                return u = r.sent(), s = _s(u, "Initialization of waitForPendingWrites() operation failed"), 
...
function ia(t, e, n) {
    var r = W(t), i = r.ua[r.currentUser.toKey()];
    // NOTE: Mutations restored from persistence won't have callbacks, so it's
    // okay for there to be no callback for this ID.
    if (i) {
        var o = i.get(e);
        o && (n ? o.reject(n) : o.resolve(), i = i.remove(e)), r.ua[r.currentUser.toKey()] = i;
    }
}

function oa(t, e, n) {
    void 0 === n && (n = null), t.sharedClientState.removeLocalQueryTarget(e);
    for (var r = 0, i = t.na.get(e); r < i.length; r++) {
        var o = i[r];
...
function ua(t, e) {
    ...
    var n = t.ia.get(e);
    null !== n && (es(t.remoteStore, n), t.ia = t.ia.remove(e), t.ra.delete(n), ca(t));
}

function sa(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Bs ? (t.oa.addReference(o.key, e), aa(t, o)) : o instanceof Ks ? (U("SyncEngine", "Document no longer in limbo: " + o.key), 
        t.oa.removeReference(o.key, e), t.oa.containsKey(o.key) || 
        // We removed the last reference for this key
        ua(t, o.key)) : j();
    }
}
...
function aa(t, e) {
    ...
    t.ia.get(n) || t.sa.has(r) || (U("SyncEngine", "New document in limbo: " + n), t.sa.add(r), 
    ca(t));
}
 ...
 */ function ca(t) {
    for (;t.sa.size > 0 && t.ia.size < t.maxConcurrentLimboResolutions; ) {
        var e = t.sa.values().next().value;
        t.sa.delete(e);
        var n = new Pt(gt.fromString(e)), r = t.ca.next();
        t.ra.set(r, new zs(n)), t.ia = t.ia.insert(n, r), ts(t.remoteStore, new Mi(We(Ue(n.path)), r, 2 /* LimboResolution */ , ut.A));
    }
}
...
function la(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = W(t), u = [], s = [], a = [], o.ea.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.ea.forEach((function(t, n) {
                    a.push(o.la(n, e, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(n.targetId, t.fromCache ? "not-current" : "current"), 
                            u.push(t);
                            var e = $o.Ys(n.targetId, t);
                            s.push(e);
                        }
                    })));
              ...
              case 1:
                return c.sent(), o.ta.Qo(u), [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                            ...
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return mi.forEach(e, (function(e) {
                                        return mi.forEach(e.Hs, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return mi.forEach(e.Js, (function(r) {
                              ...
                              case 4:
                                for (o = 0, u = e; o < u.length; o++) s = u[o], a = s.targetId, s.fromCache || (c = n.ii.get(a), 
                                l = c.snapshotVersion, h = c.withLastLimboFreeSnapshotVersion(l), 
                                // Advance the last limbo free snapshot version
                                n.ii = n.ii.insert(a, h));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                [ 4 /*yield*/ , nu(n.localStore, e) ]);

              case 1:
                return i = r.sent(), n.currentUser = e, 
                // Fails tasks waiting for pending writes requested by previous user.
                function(t, e) {
                    t.aa.forEach((function(t) {
                        t.forEach((function(t) {
                ...
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , la(n, i.hi) ];
...
function fa(t, e) {
    var n = W(t), r = n.ra.get(e);
    if (r && r.Zu) return tr().add(r.key);
    var i = tr(), o = n.na.get(e);
    if (!o) return i;
    for (var u = 0, s = o; u < s.length; u++) {
        var a = s[u], c = n.ea.get(a);
        i = i.unionWith(c.view.Ku);
    }
    return i;
}
 ...
 */ function da(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , lu((n = W(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.Yu(i), [ 2 /*return*/ , (n.isPrimaryClient && sa(n, e.targetId, o.Hu), 
                o) ];
            }
        }));
    }));
...
function pa(t, e) {
    return n(this, void 0, void 0, (function() {
        var n;
        return r(this, (function(r) {
            return [ 2 /*return*/ , fu((n = W(t)).localStore, e).then((function(t) {
                return la(n, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.fn(t, e).next((function(e) {
                            return e ? n.ci.Ks(t, e) : mi.resolve(null);
                        }));
                    }));
                }((n = W(t)).localStore, e) ];

              case 1:
                return null === (u = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , ds(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                ia(n, e, o || null), ra(n, e), function(t, e) {
                    W(W(t).Bs)._n(e);
                }(n.localStore, e)) : j(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , la(n, u) ];
...
function va(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return Ta(n = W(t)), Ea(n), !0 !== e || !0 === n.ha ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , ma(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.ha = !0, [ 4 /*yield*/ , Is(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), u = 0, s = o; u < s.length; u++) a = s[u], ts(n.remoteStore, a);
                return [ 3 /*break*/ , 7 ];

              case 3:
                return !1 !== e || !1 === n.ha ? [ 3 /*break*/ , 7 ] : (c = [], l = Promise.resolve(), 
                n.na.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : l = l.then((function() {
                        return oa(n, e), cu(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), es(n.remoteStore, e);
                })), [ 4 /*yield*/ , l ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , ma(n, c) ];
...
function ma(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, u, s, a, c, l, h, f, d, p, y, v;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
              ...
              case 1:
                return u < s.length ? (a = s[u], c = void 0, (l = n.na.get(a)) && 0 !== l.length ? [ 4 /*yield*/ , au(n.localStore, We(l[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return h < f.length ? (d = f[h], p = n.ea.get(d), [ 4 /*yield*/ , da(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , hu(n.localStore, a) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , au(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , Hs(n, ga(v), a, 
                /*current=*/ !1) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                if (!((u = n.na.get(e)) && u.length > 0)) return [ 3 /*break*/ , 7 ];
                switch (i) {
                  case "current":
                  case "not-current":
                    return [ 3 /*break*/ , 1 ];
              ...
              case 1:
                return [ 4 /*yield*/ , fu(n.localStore, Ze(u[0])) ];

              case 2:
                return s = r.sent(), a = rr.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , la(n, s, a) ];
              ...
              case 5:
                return r.sent(), oa(n, e, o), [ 3 /*break*/ , 7 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function Ia(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, u, s, a, c, l, h, f, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = Ta(t)).ha) return [ 3 /*break*/ , 10 ];
                o = 0, u = e, p.label = 1;

              case 1:
                return o < u.length ? (s = u[o], n.na.has(s) ? (
                // A target might have been added in a previous attempt
                U("SyncEngine", "Adding an already active target " + s), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , hu(n.localStore, s) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , au(n.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , Hs(n, ga(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), ts(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                l = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.na.has(t) ? [ 4 /*yield*/ , cu(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                es(n.remoteStore, t), oa(n, t);
                            })).catch(xo) ] : [ 3 /*break*/ , 2 ];
...
function Ta(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Js.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = fa.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Zs.bind(null, e), e.ta.Qo = Vs.bind(null, e.eventManager), 
    e.ta.fa = Rs.bind(null, e.eventManager), e;
}
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Us(n)), o = new qs(n, t.localStore, e.M), [ 4 /*yield*/ , e.da() ];

                  case 5:
                    u = r.sent(), r.label = 6;

                  case 6:
                    return u ? [ 4 /*yield*/ , o.ku(u) ] : [ 3 /*break*/ , 10 ];

                  case 7:
                    return (s = r.sent()) && i._updateProgress(s), [ 4 /*yield*/ , e.da() ];
                  ...
                  case 11:
                    return a = r.sent(), [ 4 /*yield*/ , la(t, a.Fu, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 13:
                    return [ 2 /*return*/ , (
                    // Save metadata, so loading the same bundle will skip.
                    r.sent(), i._completeWith(a.progress), Promise.resolve(a.Ou)) ];
...
var _a = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.M = ju(t.databaseInfo.databaseId), this.sharedClientState = this._a(t), 
                    this.persistence = this.wa(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.gcScheduler = this.ma(t), this.localStore = this.ga(t), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return eu(this.persistence, new Zo, t.initialUser, this.M);
    }, t.prototype.wa = function(t) {
        return new Su(Du.zi, this.M);
    ...
    function i(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).ya = t, i.cacheSizeBytes = n, i.forceOwnership = r, 
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    return r.sent(), [ 4 /*yield*/ , this.ya.initialize(this, t) ];

                  case 2:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , Ea(this.ya.syncEngine) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , ds(this.ya.remoteStore) ];
        ...
        return new Mo(e, t.asyncQueue);
    }, i.prototype.wa = function(t) {
        var e = Xo(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? vo.withCacheSize(this.cacheSizeBytes) : vo.DEFAULT;
        return new Wo(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Ku(), Gu(), this.M, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype._a = function(t) {
        return new Pu;
    }, i;
}(_a), Na = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
        return (r = e.call(this, t, n, /* forceOwnership= */ !1) || this).ya = t, r.cacheSizeBytes = n, 
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(u) {
                switch (u.label) {
                  ...
                  case 1:
                    return u.sent(), i = this.ya.syncEngine, this.sharedClientState instanceof Lu ? (this.sharedClientState.syncEngine = {
                        Mr: ya.bind(null, i),
                        Or: ba.bind(null, i),
                        Fr: Ia.bind(null, i),
                        Fs: wa.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.Ts((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , va(this.ya.syncEngine, t) ];
        ...
        var e = Ku();
        if (!Lu.vt(e)) throw new Y(H.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = Xo(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new Lu(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(Da), Aa = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return $s(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = ha.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , Is(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = ju(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Bu(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return $s(u.syncEngine, t, 0 /* RemoteStore */);
        }, o = Fu.vt() ? new Fu : new Ou, new Ju(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, u) {
            var s = new Qs(t, e, n, r, i, o);
            return u && (s.ha = !0), s;
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = W(t), U("RemoteStore", "RemoteStore shutting down."), e.fu.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , Zu(e) ];

                      case 1:
                        return n.sent(), e._u.shutdown(), 
                        // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
                        // triggering spurious listener events with cached data, etc.
                        e.wu.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
                    }
                }));
            }));
        }(this.remoteStore);
 ...
 */ var Ca = /** @class */ function() {
    ...
    t, e) {
        ...
        this.Aa().then((function(t) {
            t && t.xu() ? n.metadata.resolve(t.payload.metadata) : n.metadata.reject(new Error("The first element of the bundle is not a metadata, it is\n             " + JSON.stringify(null == t ? void 0 : t.payload)));
        }), (function(t) {
            ...
            return r(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    return [ 2 /*return*/ , (t.sent(), this.Aa()) ];
                }
            }));
        }));
    }, 
    ...
    /** First index of '{' from the underlying buffer. */ t.prototype.Va = function() {
    ...
    t.prototype.Ra = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Va() < 0 ? [ 4 /*yield*/ , this.va() ] : [ 3 /*break*/ , 3 ];
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    return e = this.Ea.decode(this.buffer.slice(0, t)), [ 2 /*return*/ , (this.buffer = this.buffer.slice(t), 
                    e) ];
                }
            }));
        }));
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = W(t), i = _r(n.M) + "/documents", o = {
                                        documents: e.map((function(t) {
                                            return Ir(n.M, t);
                                        }))
                                    }, [ 4 /*yield*/ , n.ho("BatchGetDocuments", i, o) ];
                                    ...
                                    return u = r.sent(), s = new Map, u.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Tr(t, e.found.name), r = gr(e.found.updateTime), i = new ie({
                                                    mapValue: {
                                                ...
                                                var n = Tr(t, e.missing), r = gr(e.readTime);
    ...
    t.prototype.precondition = function(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? bn.updateTime(e) : bn.none();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        ...
        this.Sa = 5, this.Do = new zu(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Do.To((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Ma(this.datastore), (e = this.Ca(t)) && e.then((function(e) {
        ...
        var e = this;
        this.Sa > 0 && this.Na(t) ? (this.Sa -= 1, this.asyncQueue.enqueueAndForget((function() {
            return e.Da(), Promise.resolve();
    ...
    i, o) {
        ...
        this.user = L.UNAUTHENTICATED, this.clientId = at.R(), this.authCredentialListener = function() {
            return Promise.resolve();
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = _s(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return s.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(u, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , nu(e.localStore, t) ];
...
function Pa(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , Oa(t) ];
              ...
              case 3:
                ...
                t.setCredentialChangeListener((function(t) {
                    return bs(e.remoteStore, t);
                })), t.setAppCheckTokenChangeListener((function(t, n) {
                    return bs(e.remoteStore, n);
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Ws.bind(null, e.syncEngine), 
                n.onUnlisten = Ys.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function ja(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var u = new X;
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function Ja(t) {
 ...
 */ var tc = /** @class */ function() {
    ...
    function t(t, e, n) {
        ...
        /**
             ...
             */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new tc({}), 
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new tc(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            if (!t) return new $;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */
        return t = this, (e = Qa.get(t)) && (U("ComponentProvider", "Removing Datastore"), 
        Qa.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ function nc(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        var u, s;
        if ("string" == typeof r.mockUserToken) u = r.mockUserToken, s = L.MOCK_USER; else {
            // Let createMockUserToken validate first (catches common mistakes like
            // invalid field "uid" and missing field "sub" / "user_id".)
            u = T(r.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
 ...
 */ var rc = /** @class */ function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, Ue(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function uc(t, n) {
    ...
    if (t = I(t), Wa("collection", "path", n), t instanceof ec) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return Xa(o), new oc(t, /* converter= */ null, o);
    }
    if (!(t instanceof rc || t instanceof oc)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return Xa(u), new oc(t.firestore, 
    /* converter= */ null, u);
}
 ...
 */ function sc(t, e) {
    if (t = $a(t, ec), Wa("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new Y(H.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new ic(t, 
    /* converter= */ null, 
    /**
...
function ac(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = at.R()), Wa("doc", "path", n), t instanceof ec) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return Ya(o), new rc(t, 
        /* converter= */ null, new Pt(o));
    }
    if (!(t instanceof rc || t instanceof oc)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return Ya(u), new rc(t.firestore, t instanceof oc ? t.converter : null, new Pt(u));
}
 ...
 * Firestore database.
 */ function cc(t, e) {
    return t = I(t), e = I(e), (t instanceof rc || t instanceof oc) && (e instanceof rc || e instanceof oc) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function lc(t, e) {
    return t = I(t), e = I(e), t instanceof ic && e instanceof ic && t.firestore === e.firestore && Ye(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var hc = /** @class */ function() {
    function t() {
        ...
        this.Do = new zu(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.qa = function() {
            var e = Gu();
            e && U("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Do.Ao();
        };
        var e = Gu();
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Ga((function() {
            return e.Oa && e.La ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Qa = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return n.sent(), this.Ma.shift(), this.Do.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!Ti(t = n.sent())) throw t;
        ...
        var e = this, n = this.ka.then((function() {
            return e.Ba = !0, t().catch((function(t) {
                e.$a = t, e.Ba = !1;
                var n = 
                /**
 ...
 */
    ...
    t.prototype.Wa = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.ka ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.ka) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
    ...
    t.prototype.za = function(t) {
        for (var e = 0, n = this.Fa; e < n.length; e++) {
    ...
    t.prototype.Ha = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
            ...
            e.Fa.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.Fa; n < r.length; n++) {
                var i = r[n];
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.ja = function(t) {
...
var dc = /** @class */ function() {
    ...
    function n(t, n, r) {
        ...
        /**
             ...
             */
        return (i = e.call(this, t, n, r) || this).type = "firestore", i._queue = new hc, 
    ...
    return t(n, e), n.prototype._terminate = function() {
        ...
        wc(this), this._firestoreClient.terminate();
    }, n;
}(ec);
 ...
 * @internal
 */ function gc(t) {
    return t._firestoreClient || wc(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}
...
function wc(t) {
    ...
    t._firestoreClient = new Ra(t._authCredentials, t._appCheckCredentials, t._queue, r);
}
 ...
 */ function bc(t, e) {
    Cc(t = $a(t, yc));
    var n = gc(t), r = t._freezeSettings(), i = new Aa;
    return Tc(n, i, new Da(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Ic(t) {
    Cc(t = $a(t, yc));
    var e = gc(t), n = t._freezeSettings(), r = new Aa;
    return Tc(e, r, new Na(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , La(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Pa(t, e) ];
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return wi.vt() ? (e = t + "main", [ 4 /*yield*/ , wi.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(Xo(t._databaseId, t._persistenceKey)) ];
 ...
 */ function _c(t) {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , Ba(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = W(t);
                            return e.fu.delete(0 /* UserDisabled */), $u(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (gc(t = $a(t, yc)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).fu.add(0 /* UserDisabled */), [ 4 /*yield*/ , Zu(e) ];

                                      case 1:
                                        return n.sent(), 
                                        // Set the OnlineState to Offline so get()s return from cache, etc.
                                        e.wu.set("Offline" /* Offline */), [ 2 /*return*/ ];
                                    }
                                }));
                            }));
                        }(i)) ];
...
function xc(t, e) {
    ...
    }(gc(t = $a(t, yc)), e).then((function(e) {
        return e ? new ic(t, null, e.query) : null;
    }));
}
...
}(), Pc = /^__.*__$/, Oc = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new xn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new An(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Fc = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Uc = /** @class */ function() {
    /**
    ...
    function t(t, e, n, r, i, o) {
        ...
        void 0 === i && this.Ya(), this.fieldTransforms = i || [], this.fieldMask = o || [];
    }
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Za = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.Za({
            path: n,
            ec: !1
        });
        return r.nc(t), r;
        ...
        return ul(t, this.settings.methodName, this.settings.oc || !1, this.path, this.settings.uc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.nc(this.path.get(t));
    }, t.prototype.nc = function(t) {
        if (0 === t.length) throw this.rc("Document fields must not be empty");
        if (qc(this.Xa) && Pc.test(t)) throw this.rc('Document fields cannot begin and end with "__"');
    }, t;
}(), Bc = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.M = n || ju(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.ac = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Uc({
            Xa: t,
            methodName: e,
            uc: n,
            path: bt.emptyPath(),
 ...
 * classes.
 */ function Kc(t) {
    var e = t._freezeSettings(), n = ju(t._databaseId);
    return new Bc(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Gc(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var u = t.ac(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    nl("Data must be an object, but it was:", u, r);
    var s, a, c = tl(r, u);
...
var Qc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new gn(t.path, new ln);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(Rc), Wc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).cc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = zc(this, t, 
        /*array=*/ !0), n = this.cc.map((function(t) {
            return Zc(t, e);
        })), r = new hn(n);
...
}(Rc), Yc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).hc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new yn(t.M, on(t.M, this.hc));
...
/** Parse update data from an update() call. */ function Xc(t, e, n, r) {
    var i = t.ac(1 /* Update */ , e, n);
    nl("Data must be an object, but it was:", i, r);
    var o = [], u = ie.empty();
    yt(r, (function(t, r) {
        var s = ol(e, t, n);
    ...
    var s = new It(o);
    return new Fc(u, s, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Jc(t, e, n, r, i, o) {
    var u = t.ac(1 /* Update */ , e, n), s = [ rl(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) s.push(rl(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], h = ie.empty(), f = s.length - 1; f >= 0; --f) if (!sl(l, s[f])) {
        var d = s[f], p = a[f];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
        ...
        l.push(d); else {
            var v = Zc(p, y);
            null != v && (l.push(d), h.set(d, v));
        }
    }
    var m = new It(l);
    return new Fc(h, m, u.fieldTransforms);
}
 ...
 */ function $c(t, e, n, r) {
    return void 0 === r && (r = !1), Zc(n, t.ac(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Zc(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return nl("Unsupported field value:", e, t), tl(t, e);
    if (t instanceof Rc) 
    ...
    return function(t, e) {
        ...
        if (!qc(e.Xa)) throw e.rc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return on(e.M, t);
        ...
        if (t instanceof ft) {
            ...
            return {
                timestampValue: yr(e.M, r)
            };
        }
        if (t instanceof Lc) return {
            geoPointValue: {
                latitude: t.latitude,
        ...
        if (t instanceof Vc) return {
            bytesValue: vr(e.M, t._byteString)
        };
        if (t instanceof rc) {
            var i = e.databaseId, o = t.firestore._databaseId;
            if (!o.isEqual(i)) throw e.rc("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: wr(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.rc("Unsupported field value: " + Ja(t));
    }(t, e);
}
...
function el(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ft || t instanceof Lc || t instanceof Vc || t instanceof rc || t instanceof Rc);
}
...
function nl(t, e, n) {
    if (!el(n) || !function(t) {
        ...
        var r = Ja(n);
        throw "an object" === r ? e.rc(t + " a custom object") : e.rc(t + " " + r);
    }
}
 ...
 */ function rl(t, e, n) {
    ...
    if ("string" == typeof e) return ol(t, e);
 ...
 * evaluated.
 */ function ol(t, n, r) {
    if (n.search(il) >= 0) throw ul("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (kc.bind.apply(kc, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw ul("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
 ...
 */ var al = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new cl(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(ll("DocumentSnapshot.get", t));
 ...
 */
function ll(t, e) {
    return "string" == typeof e ? ol(t, e) : e instanceof kc ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var hl = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new dl(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(ll("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(al), dl = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
...
}(fl), pl = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new hl(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new dl(n._firestore, n._userDataWriter, r.key, r, new hl(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new dl(t._firestore, t._userDataWriter, e.doc.key, e.doc, new hl(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new dl(t._firestore, t._userDataWriter, e.doc.key, e.doc, new hl(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 * limitations under the License.
 */ function ml(t) {
    if (Ke(t) && 0 === t.explicitOrderBy.length) throw new Y(H.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var bl = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).lc = t, i.fc = n, i.dc = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Kc(t.firestore), n = function(t, e, n, r, i, o, u) {
            var s;
            if (i.isKeyField()) {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || Ll(u, o), 
            s = $c(n, "where", u, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var f = Se.create(i, o, s);
            return function(t, e) {
                if (e.S()) {
                    var n = je(t);
 ...
 */
        ...
        }(t._query, 0, e, t.firestore._databaseId, this.lc, this.fc, this.dc);
...
var Tl = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).lc = t, r._c = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
...
var Sl = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.wc = n, i.mc = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        return new ic(t.firestore, t.converter, He(t._query, this.wc, this.mc));
    }, n;
}(gl);
 ...
 * @returns The created {@link Query}.
 */ function _l(t) {
    return Za("limit", t), new Sl("limit", t, "F" /* First */)
    /**
...
function Dl(t) {
    return Za("limitToLast", t), new Sl("limitToLast", t, "L" /* Last */);
}

var Nl = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.gc = n, i.yc = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Vl(t, this.type, this.gc, this.yc);
        return new ic(t.firestore, t.converter, function(t, e) {
...
function Al() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Nl("startAt", t, 
    /*inclusive=*/ !0);
}

function xl() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Nl("startAfter", t, 
    /*inclusive=*/ !1);
}
...
function kl() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Cl("endBefore", t, 
    /*inclusive=*/ !1);
}

function Ml() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Cl("endAt", t, /*inclusive=*/ !0);
}

/** Helper function to create a bound from a document or fields */ function Vl(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof al) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], u = 0, s = Qe(t); u < s.length; u++) {
            var a = s[u];
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var s = [], a = 0; a < i.length; a++) {
            ...
            if (u[a].field.isKeyField()) {
                ...
                if (!ze(t) && -1 !== c.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
...
function Rl(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        ...
        if (!ze(e) && -1 !== n.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
    ...
    if (n instanceof rc) return Qt(t, n._key);
    throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: " + Ja(n) + ".");
}
 ...
 */ var Ol = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new Lc(Dt(t.latitude), Dt(t.longitude));
...
var ql = /** @class */ function(e) {
...
}(Ol), Ul = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = Kc(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Bl(t, this._firestore), i = Fl(r.converter, e, n), o = Gc(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, bn.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, u = Bl(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof kc ? Jc(this._dataReader, "WriteBatch.update", u._key, e, n, r) : Xc(this._dataReader, "WriteBatch.update", u._key, e), 
        this._mutations.push(o.toMutation(u._key, bn.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = Bl(t, this._firestore);
        return this._mutations = this._mutations.concat(new Ln(e._key, bn.none())), this;
    }, 
    /**
 ...
 */ function Kl(t) {
    t = $a(t, rc);
    var e = $a(t.firestore, yc);
    return ja(gc(e), t._key).then((function(n) {
        return nh(e, t, n);
    }));
}
 ...
 */ function jl(t) {
    t = $a(t, rc);
    var e = $a(t.firestore, yc), i = gc(e), o = new Gl(e);
    return function(t, e) {
        var i = this, o = new X;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 2:
                                        return o = r.sent(), u = _s(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new fl(e, o, t._key, n, new hl(null !== n && n.hasLocalMutations, 
 ...
 */ function Ql(t) {
    t = $a(t, ic);
    var e = $a(t.firestore, yc), n = gc(e), r = new Gl(e);
    return ml(t._query), za(n, t._query).then((function(n) {
        return new pl(e, r, t, n);
    }))
    /**
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , lu(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new Gs(e, n.li), u = o.Gu(n.documents), s = o.applyChanges(u, 
                                        /* updateLimboDocuments= */ !1), i.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = r.sent(), c = _s(a, "Failed to execute query '" + e + " against cache"), 
...
function Yl(t, e, n) {
    t = $a(t, rc);
    var r = $a(t.firestore, yc), i = Fl(t.converter, e, n);
    return eh(r, [ Gc(Kc(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, bn.none()) ]);
}

function Xl(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = $a(t, rc);
    var o = $a(t.firestore, yc), u = Kc(o);
    return eh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof kc ? Jc(u, "updateDoc", t._key, e, n, r) : Xc(u, "updateDoc", t._key, e)).toMutation(t._key, bn.exists(!0)) ]);
}
 ...
 */ function Jl(t) {
    return eh($a(t.firestore, yc), [ new Ln(t._key, bn.none()) ]);
}
 ...
 */ function $l(t, e) {
    var n = $a(t.firestore, yc), r = ac(t), i = Fl(t.converter, e);
    return eh(n, [ Gc(Kc(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, bn.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function Zl(t) {
    ...
    "object" != typeof u[c] || fc(u[c]) || (a = u[c], c++);
    var l, h, f, d = {
    ...
    if (t instanceof rc) h = $a(t.firestore, yc), f = Ue(t._key.path), l = {
        next: function(e) {
            u[c] && u[c](nh(h, t, e));
        },
        error: u[c + 1],
        ...
        var y = $a(t, ic);
        h = $a(y.firestore, yc), f = y._query;
        var v = new Gl(h);
        l = {
            next: function(t) {
                u[c] && u[c](new pl(h, v, y, t));
            },
            error: u[c + 1],
            complete: u[c + 2]
        }, ml(t._query);
    ...
    return function(t, e, i, o) {
        var u = this, s = new Ca(o), a = new Ps(e, s, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(u, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
            ...
            s.Ia(), t.asyncQueue.enqueueAndForget((function() {
                return n(u, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e = Ms, [ 4 /*yield*/ , Ga(t) ];
...
function th(t, e) {
    return function(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            o.Ia(), t.asyncQueue.enqueueAndForget((function() {
                return n(i, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
 ...
 */ function nh(t, e, n) {
    var r = n.docs.get(e._key), i = new Gl(t);
    return new fl(t, i, e._key, r, new hl(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var rh, ih = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Bl(t, this._firestore), i = new Gl(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new fl(n._firestore, i, r._key, t._document, new hl(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Kc(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Bl(t, this._firestore), r = new ql(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return j();
            var i = t[0];
            if (i.isFoundDocument()) return new al(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new al(e._firestore, r, n._key, null, n.converter);
            throw j();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Bl(t, this._firestore), i = Fl(r.converter, e, n), o = Gc(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof kc ? Jc(this._dataReader, "Transaction.update", u._key, e, n, r) : Xc(this._dataReader, "Transaction.update", u._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new Va(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
    }(gc(t = $a(t, yc)), (function(n) {
        return e(new ih(t, n));
    }));
}
 ...
 * writes.
 */ function hh(t) {
    return gc(t = $a(t, yc)), new Ul(t, (function(e) {
        return eh(t, e);
    }))
    /**
 * @license
...
function fh(t, e) {
    ...
    // persistence since `enableIndexeddbPersistence()` can fail on the Web.
        ...
        var u = o[i], s = dh(u, "collectionGroup"), a = [];
        if (Array.isArray(u.fields)) for (var c = 0, l = u.fields; c < l.length; c++) {
            var h = l[c], f = ol("setIndexConfiguration", dh(h, "fieldPath"));
 ...
 */ void 0 === rh && (rh = !0), P = i, o(new c("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new yc(r, new tt(t.getProvider("auth-internal")), new it(t.getProvider("app-check-internal")));
