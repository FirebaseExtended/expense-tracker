...
var _nextFlightServerLoader = require("../loaders/next-flight-server-loader");
...
class FlightManifestPlugin {
    ...
    createAsset(assets, compilation) {
        const manifest = {};
        const isClientComponent = (0, _nextFlightServerLoader).createClientComponentFilter(this.pageExtensions);
