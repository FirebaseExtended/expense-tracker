...
async function build(dir, conf = null, reactProductionProfiling = false, debugOutput = false, runLint = true) {
    ...
    const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
        ...
        const entrypoints = await nextBuildSpan.traceChild('create-entrypoints').traceAsyncFn(()=>(0, _entries).createEntrypoints(mappedPages, target, buildId, previewProps, config, loadedEnvFiles, pagesDir, false)
        );
            ...
            await Promise.all(pageKeys.map(async (page)=>{
                ...
                return checkPageSpan.traceAsyncFn(async ()=>{
                    ...
                    if (hasServerComponents && pagePath) {
                        if ((0, _utils2).isFlightPage(config, pagePath)) {
