...
class HotReloader {
    ...
    async getWebpackConfig(span) {
        ...
        return webpackConfigSpan.traceAsyncFn(async ()=>{
            ...
            const entrypoints = await webpackConfigSpan.traceChild('create-entrypoints').traceAsyncFn(()=>(0, _entries).createEntrypoints(this.pagesMapping, 'server', this.buildId, this.previewProps, this.config, [], this.pagesDir, true)
            );
    ...
    async buildFallbackError() {
        ...
        const fallbackConfig = await (0, _webpackConfig).default(this.dir, {
            ...
            }, 'server', this.buildId, this.previewProps, this.config, [], this.pagesDir, true)).client,
            hasReactRoot: this.hasReactRoot
        });
