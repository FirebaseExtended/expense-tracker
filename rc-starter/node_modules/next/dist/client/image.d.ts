...
export default function Image({ src, sizes, unoptimized, priority, loading, lazyRoot, lazyBoundary, className, quality, width, height, style, objectFit, objectPosition, onLoadingComplete, onError, placeholder, blurDataURL, ...all }: ImageProps): JSX.Element;
export {};
