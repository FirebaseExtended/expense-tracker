      ...
      <DialogContent className={styles.pickImage}>
        ...
        {(isEdit || isConfirm) ?
          <Stack className={styles.fields}>
            ...
            <TextField color="tertiary" label="Location name" variant="standard" value={formFields.locationName} onChange={() => setFormFields(prevState => ({...prevState, locationName: event.target.value}))} />
            <TextField color="tertiary" label="Location address" variant="standard" value={formFields.address} onChange={() => setFormFields(prevState => ({...prevState, address: event.target.value}))} />
            <TextField color="tertiary" label="Items" variant="standard" value={formFields.items} onChange={() => setFormFields(prevState => ({...prevState, items: event.target.value}))}/>
            <TextField color="tertiary" label="Amount" variant="standard" value={formFields.amount} onChange={() => setFormFields(prevState => ({...prevState, amount: event.target.value}))} />
          </Stack> : <div></div>
        }
      </DialogContent>
      <DialogActions>
